...
func TestApiKeyAuthWithSubscriptionGoogle_AllowsModelListWithExhaustedBalance(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	r.GET("/antigravity/v1beta/models", func(c *gin.Context) { c.JSON(200, gin.H{"ok": true}) })
	r.GET("/v1beta/test", func(c *gin.Context) { c.JSON(200, gin.H{"ok": true}) })
