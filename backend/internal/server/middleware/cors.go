...
func CORS(cfg config.CORSConfig) gin.HandlerFunc {
	...
	// API keys are sent explicitly by clients, so the API can safely support
	// browser-based OpenAI-compatible clients without cookies by default.
	...
	allowHeaders := []string{
		...
		// Some OpenAI-compatible browser clients send Anthropic compatibility
		// headers even when the selected protocol is OpenAI/chat.
