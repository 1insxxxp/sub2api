...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, optionalJWTAuth, adminAuth, adminWorkbenchAuth, apiKeyAuth, auditLog, stepUpAuth, apiKeyService, subscriptionService, opsService, settingService, compositeResolver, cfg, redisClient)
}
