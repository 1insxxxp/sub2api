...
func createGroupRecord(ctx context.Context, client *dbent.Client, groupIn *service.Group) error {
	...
	builder := client.Group.Create().
		...
		SetSystemCustomRoutingEnabled(groupIn.SystemCustomRoutingEnabled).
		...
		SetDefaultReasoningEffort(groupIn.DefaultReasoningEffort).
		...
		SetModelStatusVisibility(groupIn.ModelStatusVisibility).
