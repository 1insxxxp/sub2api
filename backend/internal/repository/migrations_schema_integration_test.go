...
func TestMigrationsRunner_IsIdempotent_AndSchemaIsUpToDate(t *testing.T) {
	...
	requireColumn(t, tx, "accounts", "model_system_prompts", "jsonb", 0, false)
	requireColumnDefaultContains(t, tx, "accounts", "model_system_prompts", "{}", "jsonb")
	...
	requireIndex(t, tx, "redeem_codes", "idx_redeem_codes_created_by")
	requireIndex(t, tx, "redeem_codes", "idx_redeem_codes_source")
	...
	requireColumn(t, tx, "usage_logs", "upstream_output_tokens", "integer", 0, false)
	requireColumnDefaultContains(t, tx, "usage_logs", "upstream_output_tokens", "0")
