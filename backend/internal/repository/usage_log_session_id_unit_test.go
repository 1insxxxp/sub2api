...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 63, "arg-type table must include gift classification, response model audit, source/custom groups, requested reasoning effort, and session_id")
