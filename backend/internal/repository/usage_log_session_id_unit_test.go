...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 62, "arg-type table must include response model audit, source/custom groups, requested reasoning effort, and session_id")
