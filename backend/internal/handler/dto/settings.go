...
type SystemSettings struct {
	...
	PaymentBalanceRechargeTiers      []service.BalanceRechargeTier     `json:"payment_balance_recharge_tiers,omitempty"`
	PaymentBalanceRechargePromotion  *service.BalanceRechargePromotion `json:"payment_balance_recharge_promotion,omitempty"`
