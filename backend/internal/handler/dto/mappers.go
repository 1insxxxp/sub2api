...
func GroupFromServiceAdmin(g *service.Group) *AdminGroup {
	...
	out := &AdminGroup{
		...
		ModelStatusVisibility:       g.ModelStatusVisibility,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		CompensatedCost:           l.CompensatedCost,
		NetActualCost:             l.NetActualCost(),
		CompensationEligible:      l.CompensationEligible,
		CompensationEligibility:   l.CompensationEligibility,
		CompensationReasonCode:    l.CompensationReasonCode,
		ClaimStatus:               l.EmptyResponseClaimStatus,
...
func EmptyResponseClaimFromServiceAdmin(claim *service.EmptyResponseClaim) *AdminEmptyResponseClaim {
	...
	return &AdminEmptyResponseClaim{
		...
		CompensationSource:  claim.CompensationSource(),
		...
		UsageCreatedAt:      claim.UsageCreatedAt,
		InputTokens:         claim.InputTokens,
		OutputTokens:        claim.OutputTokens,
		CacheCreationTokens: claim.CacheCreationTokens,
		CacheReadTokens:     claim.CacheReadTokens,
		TotalCost:           claim.TotalCost,
		ActualCost:          claim.ActualCost,
		CompensatedCost:     claim.CompensatedCost,
		BillingType:         claim.BillingType,
		RequestType:         claim.RequestType.String(),
		Stream:              claim.Stream,
		DurationMs:          claim.DurationMs,
		FirstTokenMs:        claim.FirstTokenMs,
		InboundEndpoint:     claim.InboundEndpoint,
		UpstreamEndpoint:    claim.UpstreamEndpoint,
