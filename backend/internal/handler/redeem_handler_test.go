...
func TestRedeemHistory(t *testing.T) {
	for _, tt := range []struct {
		...
		{"legacy size alias", "?limit=50", 7, 200, 1, 50},
		{"size overrides alias", "?limit=10&page_size=50", 7, 200, 1, 50},
		{"invalid alias", "?limit=-1", 7, 400, 0, 0},
		{"second user", "?page=2&page_size=100&user_id=7", 8, 200, 2, 100},
		{"custom size", "?page_size=200", 7, 200, 1, 200},
		{"maximum size", "?page_size=1000", 7, 200, 1, 1000},
		{"cap", "?page_size=1001", 7, 200, 1, 1000},
