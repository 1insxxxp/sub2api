...
type UsageHandler struct {
	...
	emptyResponseClaimService *service.EmptyResponseClaimService
}

func (h *UsageHandler) SetEmptyResponseClaimService(claimService *service.EmptyResponseClaimService) {
