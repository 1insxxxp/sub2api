...
type UpdateSettingsRequest struct {
	...
	PaymentBalanceRechargePromotion  *service.BalanceRechargePromotion `json:"payment_balance_recharge_promotion"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	delete(omitted, service.SettingKeySiteName)
	delete(omitted, service.SettingKeySiteLogo)
	delete(omitted, service.SettingKeySiteSubtitle)
	...
	if h.paymentConfigService != nil && hasPaymentFields(req) {
		paymentReq := service.UpdatePaymentConfigRequest{
			...
			BalanceRechargePromotion:      req.PaymentBalanceRechargePromotion,
	...
	payload := dto.SystemSettings{
		...
		PaymentBalanceRechargePromotion:                        updatedPaymentCfg.BalanceRechargePromotion,
...
func hasPaymentFields(req UpdateSettingsRequest) bool {
	return req.PaymentEnabled != nil || req.PaymentMinAmount != nil ||
		...
		req.PaymentBalanceRechargeMultiplier != nil || req.PaymentBalanceRechargeTiers != nil || req.PaymentBalanceRechargePromotion != nil || req.PaymentSubscriptionUSDToCNYRate != nil ||
