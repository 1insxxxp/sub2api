...
func NewGroupHandler(adminService service.AdminService, dashboardService *service.DashboardService, groupCapacityService *service.GroupCapacityService, pricingCoverage *service.GroupPricingCoverageService) *GroupHandler {
	return NewGroupHandlerWithDependencies(adminService, dashboardService, groupCapacityService, pricingCoverage, nil)
}
...
func NewGroupHandlerWithConfig(adminService service.AdminService, dashboardService *service.DashboardService, groupCapacityService *service.GroupCapacityService, cfg *config.Config) *GroupHandler {
	return NewGroupHandlerWithDependencies(adminService, dashboardService, groupCapacityService, nil, cfg)
}

func NewGroupHandlerWithDependencies(adminService service.AdminService, dashboardService *service.DashboardService, groupCapacityService *service.GroupCapacityService, pricingCoverage *service.GroupPricingCoverageService, cfg *config.Config) *GroupHandler {
	return &GroupHandler{
...
type CreateGroupRequest struct {
	...
	ModelStatusVisibility       service.GroupModelStatusVisibility        `json:"model_status_visibility"`
...
func (h *GroupHandler) Create(c *gin.Context) {
	...
	group, err := h.adminService.CreateGroup(c.Request.Context(), &service.CreateGroupInput{
		...
		DefaultReasoningEffort:           derefString(req.DefaultReasoningEffort),
		...
		ModelStatusVisibility:            req.ModelStatusVisibility,
