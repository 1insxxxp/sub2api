...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		AffiliateQualificationAmount:                           settings.AffiliateQualificationAmount,
		AffiliateBronzeInvitees:                                settings.AffiliateBronzeInvitees,
		AffiliateBronzeRate:                                    settings.AffiliateBronzeRate,
		AffiliateSilverInvitees:                                settings.AffiliateSilverInvitees,
		AffiliateSilverRate:                                    settings.AffiliateSilverRate,
		AffiliateGoldInvitees:                                  settings.AffiliateGoldInvitees,
		AffiliateGoldRate:                                      settings.AffiliateGoldRate,
		...
		PaymentBalanceRechargePromotion:                        paymentCfg.BalanceRechargePromotion,
