...
var (
	...
	ErrSystemCustomGroupEndpointUnsupported  = infraerrors.New(501, "SYSTEM_CUSTOM_GROUP_ENDPOINT_UNSUPPORTED", "this endpoint is not supported for system custom subscription groups")
)
