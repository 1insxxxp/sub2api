...
func ProvideImageTaskService(store ImageTaskStore, storage ImageResultStorage, cfg *config.Config) *ImageTaskService {
...
func ProvideAPIKeyService(
	...
	svc.customGroupRepo = customGroupRepo
	svc.SetSystemCustomGroupRepository(systemCustomGroupRepo)
...
var ProviderSet = wire.NewSet(
	...
	NewGroupService,
	NewSystemCustomGroupServiceWithCacheInvalidation,
	wire.Bind(new(SystemCustomGroupModelCatalog), new(*GatewayService)),
	NewUserCustomGroupService,
	...
	NewPromoService,
	NewUsageService,
	NewEmptyResponseCompensationService,
	NewEmptyResponseClaimService,
	NewEmptyResponseClaimAdminService,
	wire.Bind(new(EmptyResponseCompensationCacheInvalidator), new(*BillingCacheService)),
	wire.Bind(new(EmptyResponseClaimCompensator), new(*EmptyResponseCompensationService)),
	NewDashboardService,
