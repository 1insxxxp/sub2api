...
func TestEvaluateEmptyResponseClaimDecisionTable(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "client cancellation rejects without output", usage: baseUsage, group: baseGroup, outcome: &ResponseOutcome{HTTPStatus: 200, UpstreamStatus: 200, DisconnectSource: DisconnectSourceClient, CollectorVersion: 1}, status: EmptyResponseClaimRejected, reason: EmptyResponseReasonClientCancelled},
		{name: "client cancellation rejects after terminal signal", usage: baseUsage, group: baseGroup, outcome: &ResponseOutcome{HTTPStatus: 200, UpstreamStatus: 200, StreamCompleted: true, DisconnectSource: DisconnectSourceClient, CollectorVersion: 1}, status: EmptyResponseClaimRejected, reason: EmptyResponseReasonClientCancelled},
		{name: "low text output rejects", usage: UsageLog{ActualCost: 1.25, OutputTokens: 10, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: &ResponseOutcome{HTTPStatus: 200, UpstreamStatus: 200, HasText: true, StreamCompleted: true, CollectorVersion: 1}, status: EmptyResponseClaimRejected, reason: EmptyResponseReasonEffectiveOutput},
		{name: "synchronous low output trusts provider usage without response evidence", usage: UsageLog{ActualCost: 1.25, OutputTokens: 10, Stream: false, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: nil, status: EmptyResponseClaimApproved, reason: EmptyResponseReasonLowOutput},
		{name: "synchronous zero output trusts provider usage without response evidence", usage: UsageLog{ActualCost: 1.25, OutputTokens: 0, Stream: false, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: nil, status: EmptyResponseClaimApproved, reason: EmptyResponseReasonLowOutput},
		{name: "streaming low output without response evidence requires review", usage: UsageLog{ActualCost: 1.25, OutputTokens: 10, Stream: true, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: nil, status: EmptyResponseClaimManualReview, reason: EmptyResponseReasonMissingEvidence},
		{name: "streaming zero output without response evidence requires review", usage: UsageLog{ActualCost: 1.25, OutputTokens: 0, Stream: true, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: nil, status: EmptyResponseClaimManualReview, reason: EmptyResponseReasonMissingEvidence},
		{name: "visible client output rejects despite low reported tokens", usage: UsageLog{ActualCost: 1.25, OutputTokens: 7, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: &ResponseOutcome{HTTPStatus: 200, UpstreamStatus: 200, HasText: true, OutputBytes: 807, StreamCompleted: false, DisconnectSource: DisconnectSourceClient, CollectorVersion: 1}, status: EmptyResponseClaimRejected, reason: EmptyResponseReasonEffectiveOutput},
		...
		{name: "missing evidence with invalid token count", usage: UsageLog{ActualCost: 1, OutputTokens: -1, Stream: true, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: nil, status: EmptyResponseClaimManualReview, reason: EmptyResponseReasonMissingEvidence},
		...
		{name: "historical streaming row without outcome requires review", usage: UsageLog{ActualCost: 1, Stream: true, CreatedAt: now.Add(-23 * time.Hour)}, group: baseGroup, outcome: nil, status: EmptyResponseClaimManualReview, reason: EmptyResponseReasonMissingEvidence},
	}
