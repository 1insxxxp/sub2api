...
func TestEvaluateEmptyResponseClaimDecisionTable(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "low output without response evidence requires review", usage: UsageLog{ActualCost: 1.25, OutputTokens: 10, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: nil, status: EmptyResponseClaimManualReview, reason: EmptyResponseReasonMissingEvidence},
		{name: "zero output without response evidence requires review", usage: UsageLog{ActualCost: 1.25, OutputTokens: 0, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: nil, status: EmptyResponseClaimManualReview, reason: EmptyResponseReasonMissingEvidence},
		...
		{name: "historical row without outcome requires review", usage: UsageLog{ActualCost: 1, CreatedAt: now.Add(-23 * time.Hour)}, group: baseGroup, outcome: nil, status: EmptyResponseClaimManualReview, reason: EmptyResponseReasonMissingEvidence},
	}
