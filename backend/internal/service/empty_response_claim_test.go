...
func TestEvaluateEmptyResponseClaimDecisionTable(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "low text output allows compensation", usage: UsageLog{ActualCost: 1.25, OutputTokens: 10, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: &ResponseOutcome{HTTPStatus: 200, UpstreamStatus: 200, HasText: true, StreamCompleted: true, CollectorVersion: 1}, status: EmptyResponseClaimApproved, reason: EmptyResponseReasonLowOutput},
		...
		{name: "visible client output allows low reported tokens", usage: UsageLog{ActualCost: 1.25, OutputTokens: 7, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: &ResponseOutcome{HTTPStatus: 200, UpstreamStatus: 200, HasText: true, OutputBytes: 807, StreamCompleted: false, DisconnectSource: DisconnectSourceClient, CollectorVersion: 1}, status: EmptyResponseClaimApproved, reason: EmptyResponseReasonLowOutput},
