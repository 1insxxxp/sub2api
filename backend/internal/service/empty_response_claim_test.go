...
func TestEvaluateEmptyResponseClaimDecisionTable(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "client cancellation allows low output", usage: baseUsage, group: baseGroup, outcome: &ResponseOutcome{HTTPStatus: 200, UpstreamStatus: 200, DisconnectSource: DisconnectSourceClient, CollectorVersion: 1}, status: EmptyResponseClaimApproved, reason: EmptyResponseReasonLowOutput},
		...
		{name: "low reported output with visible text is rejected", usage: UsageLog{ActualCost: 1.25, OutputTokens: 10, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: &ResponseOutcome{HTTPStatus: 200, UpstreamStatus: 200, HasText: true, StreamCompleted: true, CollectorVersion: 1}, status: EmptyResponseClaimRejected, reason: EmptyResponseReasonEffectiveOutput},
		...
		{name: "streaming low output without response evidence is approved", usage: UsageLog{ActualCost: 1.25, OutputTokens: 10, Stream: true, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: nil, status: EmptyResponseClaimApproved, reason: EmptyResponseReasonLowOutput},
		{name: "streaming zero output without response evidence is approved", usage: UsageLog{ActualCost: 1.25, OutputTokens: 0, Stream: true, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: nil, status: EmptyResponseClaimApproved, reason: EmptyResponseReasonLowOutput},
		{name: "visible client output rejects low reported tokens", usage: UsageLog{ActualCost: 1.25, OutputTokens: 7, CreatedAt: baseUsage.CreatedAt}, group: baseGroup, outcome: &ResponseOutcome{HTTPStatus: 200, UpstreamStatus: 200, HasText: true, OutputBytes: 807, StreamCompleted: false, DisconnectSource: DisconnectSourceClient, CollectorVersion: 1}, status: EmptyResponseClaimRejected, reason: EmptyResponseReasonEffectiveOutput},
		...
		{name: "historical streaming row without outcome is approved", usage: UsageLog{ActualCost: 1, Stream: true, CreatedAt: now.Add(-23 * time.Hour)}, group: baseGroup, outcome: nil, status: EmptyResponseClaimApproved, reason: EmptyResponseReasonLowOutput},
	}
