...
func TestEvaluateEmptyResponseClaimDecisionTable(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "low output ignores group disabled", usage: baseUsage, group: Group{}, outcome: pureEmpty, status: EmptyResponseClaimApproved, reason: EmptyResponseReasonPureEmpty},
