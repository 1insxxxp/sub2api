...
func TestShouldRefreshOpenAICodexSnapshot_SparkShadowIgnoresWSv2(t *testing.T) {
	...
	if !shouldRefreshOpenAICodexSnapshot(shadowStale, usage, now, false) {
	...
	if shouldRefreshOpenAICodexSnapshot(shadowFresh, usage, now, false) {
	...
	if shouldRefreshOpenAICodexSnapshot(normalNoWS, usage, now, false) {
