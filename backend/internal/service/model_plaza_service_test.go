...
func TestListPlazaGroups_GroupCentricAggregation(t *testing.T) {
	...
	groups := []Group{
		{ID: 10, Name: "g-main", Description: "desc", Platform: "anthropic", RateMultiplier: 1, Tag: "custom", TagColor: "#123456"},
	...
	require.Equal(t, "custom", out[0].Tag)
	require.Equal(t, "#123456", out[0].TagColor)
