...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	imageStudioGatewayExecutor := service.NewImageStudioGatewayExecutor(apiKeyService, billingCacheService, userSubscriptionRepository, openAIGatewayService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, userCustomGroupHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, handlerCheckinHandler, imageStudioHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, lotteryHandler, adminLotteryHandler, idempotencyCoordinator, idempotencyCleanupService, openAIQuotaAutoResetService)
