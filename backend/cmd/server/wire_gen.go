...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	groupHandler := admin.NewGroupHandler(adminService, dashboardService, groupCapacityService, groupPricingCoverageService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, userCustomGroupHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, handlerCheckinHandler, imageStudioHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, lotteryHandler, adminLotteryHandler, internalDujiaoAuthHandler, publicGroupSyncHandler, idempotencyCoordinator, idempotencyCleanupService, openAIQuotaAutoResetService)
