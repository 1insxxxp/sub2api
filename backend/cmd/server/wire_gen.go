...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	userCustomGroupRepository := repository.NewUserCustomGroupRepository(client, db)
	systemCustomGroupRepository := repository.NewSystemCustomGroupRepository(client)
	apiKeyCache := repository.NewAPIKeyCache(redisClient)
	concurrencyCache := repository.ProvideConcurrencyCache(redisClient, configConfig)
	schedulerCache := repository.ProvideSchedulerCache(redisClient, configConfig)
	accountRepository := repository.NewAccountRepository(client, db, schedulerCache)
	concurrencyService := service.ProvideConcurrencyService(concurrencyCache, accountRepository, configConfig)
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, userCustomGroupRepository, systemCustomGroupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, configConfig, billingCacheService, concurrencyService)
	...
	userService := service.ProvideUserService(userRepository, settingRepository, apiKeyAuthCacheInvalidator, billingCache, apiKeyRepository)
	...
	userCustomGroupService := service.NewUserCustomGroupService(userCustomGroupRepository, userRepository, groupRepository, gatewayService, apiKeyAuthCacheInvalidator)
	userCustomGroupHandler := handler.NewUserCustomGroupHandler(userCustomGroupService, apiKeyService, gatewayService)
	...
	emptyResponseClaimRepository := repository.NewEmptyResponseClaimRepository(db)
	emptyResponseCompensationRepository := repository.NewEmptyResponseCompensationRepository(db)
	emptyResponseCompensationService := service.NewEmptyResponseCompensationService(emptyResponseCompensationRepository, billingCacheService, apiKeyAuthCacheInvalidator)
	emptyResponseClaimService := service.NewEmptyResponseClaimService(emptyResponseClaimRepository, emptyResponseCompensationService)
	usageHandler := handler.ProvideUsageHandler(usageService, apiKeyService, opsService, settingService, emptyResponseClaimService)
	...
	groupPricingCoverageService := service.NewGroupPricingCoverageService(modelPricingResolver)
	adminService := service.NewAdminService(configConfig, userRepository, adminGroupRepository, adminAccountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, openAIGatewayService, affiliateService, compositeModelRouteRepository, compositeRouteResolver, channelService, channelRepository, userCustomGroupRepository, systemCustomGroupRepository, groupPricingCoverageService)
	...
	groupHandler := admin.NewGroupHandlerWithDependencies(adminService, dashboardService, groupCapacityService, groupPricingCoverageService, configConfig)
	...
	channelHandler := admin.NewChannelHandler(channelService, billingService, pricingService, gatewayService)
	...
	checkinService := service.ProvideCheckinService(client, settingRepository, apiKeyAuthCacheInvalidator, billingCache)
	...
	publicGroupRepository := repository.NewPublicGroupRepository(client, db)
	modelStatusService := service.NewModelStatusService(modelStatusRepository, publicGroupRepository, accountRepository, opsService)
	...
	imageTaskService := service.ProvideImageTaskService(imageTaskStore, imageResultStorage, configConfig)
	...
	internalDujiaoAuthHandler := handler.NewInternalDujiaoAuthHandler(configConfig, authService)
	publicGroupSyncService := service.NewPublicGroupSyncService(groupRepository, channelRepository, accountRepository)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, userCustomGroupHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, handlerCheckinHandler, imageStudioHandler, modelPlazaHandler, modelStatusHandler, asyncImageHandler, batchImageHandler, handlerLotteryHandler, lotteryHandler, internalDujiaoAuthHandler, publicGroupSyncHandler, idempotencyCoordinator, idempotencyCleanupService, openAIQuotaAutoResetService)
	jwtAuthMiddleware := middleware.NewJWTAuthMiddleware(authService, userService, settingService, auditLogService)
	optionalJWTAuthMiddleware := middleware.NewOptionalJWTAuthMiddleware(authService, userService, settingService, auditLogService)
	adminAuthMiddleware := middleware.NewAdminAuthMiddleware(authService, userService, settingService, auditLogService)
	adminWorkbenchAuthMiddleware := middleware.NewAdminWorkbenchAuthMiddleware(authService, userService, settingService, auditLogService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, adminWorkbenchAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, compositeRouteResolver, redisClient)
	...
	affiliateQualificationRecoveryWorker := service.ProvideAffiliateQualificationRecoveryWorker(affiliateService)
