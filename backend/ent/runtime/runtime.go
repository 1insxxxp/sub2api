...
func init() {
	...
	groupDescEmptyResponseCompensationEnabled := groupFields[3].Descriptor()
	...
	groupDescSystemCustomRoutingEnabled := groupFields[13].Descriptor()
	...
	groupDescDefaultReasoningEffort := groupFields[43].Descriptor()
	...
	groupDescSimulateClaudeMaxEnabled := groupFields[56].Descriptor()
