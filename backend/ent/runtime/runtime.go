...
func init() {
	...
	// accountDescModelSystemPrompts is the schema descriptor for model_system_prompts field.
	accountDescModelSystemPrompts := accountFields[6].Descriptor()
	// account.DefaultModelSystemPrompts holds the default value on creation for the model_system_prompts field.
	account.DefaultModelSystemPrompts = accountDescModelSystemPrompts.Default.(func() map[string]string)
	...
	// channelmonitorDescModelMappings is the schema descriptor for model_mappings field.
	channelmonitorDescModelMappings := channelmonitorFields[9].Descriptor()
	// channelmonitor.DefaultModelMappings holds the default value on creation for the model_mappings field.
	channelmonitor.DefaultModelMappings = channelmonitorDescModelMappings.Default.(map[string]string)
	...
	emptyresponseclaimFields := schema.EmptyResponseClaim{}.Fields()
	_ = emptyresponseclaimFields
	// emptyresponseclaimDescStatus is the schema descriptor for status field.
	emptyresponseclaimDescStatus := emptyresponseclaimFields[7].Descriptor()
	// emptyresponseclaim.DefaultStatus holds the default value on creation for the status field.
	emptyresponseclaim.DefaultStatus = emptyresponseclaimDescStatus.Default.(string)
	// emptyresponseclaim.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	emptyresponseclaim.StatusValidator = emptyresponseclaimDescStatus.Validators[0].(func(string) error)
	// emptyresponseclaimDescReasonCode is the schema descriptor for reason_code field.
	emptyresponseclaimDescReasonCode := emptyresponseclaimFields[8].Descriptor()
	// emptyresponseclaim.DefaultReasonCode holds the default value on creation for the reason_code field.
	emptyresponseclaim.DefaultReasonCode = emptyresponseclaimDescReasonCode.Default.(string)
	// emptyresponseclaim.ReasonCodeValidator is a validator for the "reason_code" field. It is called by the builders before save.
	emptyresponseclaim.ReasonCodeValidator = emptyresponseclaimDescReasonCode.Validators[0].(func(string) error)
	// emptyresponseclaimDescUserReason is the schema descriptor for user_reason field.
	emptyresponseclaimDescUserReason := emptyresponseclaimFields[9].Descriptor()
	// emptyresponseclaim.DefaultUserReason holds the default value on creation for the user_reason field.
	emptyresponseclaim.DefaultUserReason = emptyresponseclaimDescUserReason.Default.(string)
	// emptyresponseclaim.UserReasonValidator is a validator for the "user_reason" field. It is called by the builders before save.
	emptyresponseclaim.UserReasonValidator = emptyresponseclaimDescUserReason.Validators[0].(func(string) error)
	// emptyresponseclaimDescAdminNote is the schema descriptor for admin_note field.
	emptyresponseclaimDescAdminNote := emptyresponseclaimFields[10].Descriptor()
	// emptyresponseclaim.DefaultAdminNote holds the default value on creation for the admin_note field.
	emptyresponseclaim.DefaultAdminNote = emptyresponseclaimDescAdminNote.Default.(string)
	// emptyresponseclaimDescOriginalActualCost is the schema descriptor for original_actual_cost field.
	emptyresponseclaimDescOriginalActualCost := emptyresponseclaimFields[11].Descriptor()
	// emptyresponseclaim.DefaultOriginalActualCost holds the default value on creation for the original_actual_cost field.
	emptyresponseclaim.DefaultOriginalActualCost = emptyresponseclaimDescOriginalActualCost.Default.(float64)
	// emptyresponseclaimDescBalanceRefund is the schema descriptor for balance_refund field.
	emptyresponseclaimDescBalanceRefund := emptyresponseclaimFields[12].Descriptor()
	// emptyresponseclaim.DefaultBalanceRefund holds the default value on creation for the balance_refund field.
	emptyresponseclaim.DefaultBalanceRefund = emptyresponseclaimDescBalanceRefund.Default.(float64)
	// emptyresponseclaimDescSubscriptionRefund is the schema descriptor for subscription_refund field.
	emptyresponseclaimDescSubscriptionRefund := emptyresponseclaimFields[13].Descriptor()
	// emptyresponseclaim.DefaultSubscriptionRefund holds the default value on creation for the subscription_refund field.
	emptyresponseclaim.DefaultSubscriptionRefund = emptyresponseclaimDescSubscriptionRefund.Default.(float64)
	// emptyresponseclaimDescAPIKeyQuotaRefund is the schema descriptor for api_key_quota_refund field.
	emptyresponseclaimDescAPIKeyQuotaRefund := emptyresponseclaimFields[14].Descriptor()
	// emptyresponseclaim.DefaultAPIKeyQuotaRefund holds the default value on creation for the api_key_quota_refund field.
	emptyresponseclaim.DefaultAPIKeyQuotaRefund = emptyresponseclaimDescAPIKeyQuotaRefund.Default.(float64)
	// emptyresponseclaimDescRuleVersion is the schema descriptor for rule_version field.
	emptyresponseclaimDescRuleVersion := emptyresponseclaimFields[16].Descriptor()
	// emptyresponseclaim.DefaultRuleVersion holds the default value on creation for the rule_version field.
	emptyresponseclaim.DefaultRuleVersion = emptyresponseclaimDescRuleVersion.Default.(int)
	// emptyresponseclaimDescCreatedAt is the schema descriptor for created_at field.
	emptyresponseclaimDescCreatedAt := emptyresponseclaimFields[20].Descriptor()
	// emptyresponseclaim.DefaultCreatedAt holds the default value on creation for the created_at field.
	emptyresponseclaim.DefaultCreatedAt = emptyresponseclaimDescCreatedAt.Default.(func() time.Time)
	// emptyresponseclaimDescUpdatedAt is the schema descriptor for updated_at field.
	emptyresponseclaimDescUpdatedAt := emptyresponseclaimFields[21].Descriptor()
	// emptyresponseclaim.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	emptyresponseclaim.DefaultUpdatedAt = emptyresponseclaimDescUpdatedAt.Default.(func() time.Time)
	// emptyresponseclaim.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	emptyresponseclaim.UpdateDefaultUpdatedAt = emptyresponseclaimDescUpdatedAt.UpdateDefault.(func() time.Time)
	...
	groupDescTag := groupFields[2].Descriptor()
	...
	// groupDescTagColor is the schema descriptor for tag_color field.
	groupDescTagColor := groupFields[3].Descriptor()
	// group.DefaultTagColor holds the default value on creation for the tag_color field.
	group.DefaultTagColor = groupDescTagColor.Default.(string)
	// group.TagColorValidator is a validator for the "tag_color" field. It is called by the builders before save.
	group.TagColorValidator = groupDescTagColor.Validators[0].(func(string) error)
	...
	// groupDescEmptyResponseCompensationEnabled is the schema descriptor for empty_response_compensation_enabled field.
	groupDescEmptyResponseCompensationEnabled := groupFields[5].Descriptor()
	// group.DefaultEmptyResponseCompensationEnabled holds the default value on creation for the empty_response_compensation_enabled field.
	group.DefaultEmptyResponseCompensationEnabled = groupDescEmptyResponseCompensationEnabled.Default.(bool)
	...
	// groupDescSystemCustomRoutingEnabled is the schema descriptor for system_custom_routing_enabled field.
	groupDescSystemCustomRoutingEnabled := groupFields[15].Descriptor()
	// group.DefaultSystemCustomRoutingEnabled holds the default value on creation for the system_custom_routing_enabled field.
	group.DefaultSystemCustomRoutingEnabled = groupDescSystemCustomRoutingEnabled.Default.(bool)
	...
	// groupDescDefaultReasoningEffort is the schema descriptor for default_reasoning_effort field.
	groupDescDefaultReasoningEffort := groupFields[45].Descriptor()
	// group.DefaultDefaultReasoningEffort holds the default value on creation for the default_reasoning_effort field.
	group.DefaultDefaultReasoningEffort = groupDescDefaultReasoningEffort.Default.(string)
	// group.DefaultReasoningEffortValidator is a validator for the "default_reasoning_effort" field. It is called by the builders before save.
	group.DefaultReasoningEffortValidator = groupDescDefaultReasoningEffort.Validators[0].(func(string) error)
	...
	groupDescSimulateClaudeMaxEnabled := groupFields[58].Descriptor()
	...
	// groupDescModelStatusVisibility is the schema descriptor for model_status_visibility field.
	groupDescModelStatusVisibility := groupFields[61].Descriptor()
	// group.DefaultModelStatusVisibility holds the default value on creation for the model_status_visibility field.
	group.DefaultModelStatusVisibility = groupDescModelStatusVisibility.Default.(domain.GroupModelStatusVisibility)
	...
	// lotteryactivity.AttemptLimitValidator is a validator for the "attempt_limit" field. It is called by the builders before save.
	lotteryactivity.AttemptLimitValidator = lotteryactivityDescAttemptLimit.Validators[0].(func(int) error)
	...
	lotteryattemptledgerDescDelta := lotteryattemptledgerFields[1].Descriptor()
	// lotteryattemptledger.DeltaValidator is a validator for the "delta" field. It is called by the builders before save.
	lotteryattemptledger.DeltaValidator = lotteryattemptledgerDescDelta.Validators[0].(func(int) error)
	// lotteryattemptledgerDescBalanceAfter is the schema descriptor for balance_after field.
	lotteryattemptledgerDescBalanceAfter := lotteryattemptledgerFields[2].Descriptor()
	// lotteryattemptledger.BalanceAfterValidator is a validator for the "balance_after" field. It is called by the builders before save.
	lotteryattemptledger.BalanceAfterValidator = lotteryattemptledgerDescBalanceAfter.Validators[0].(func(int) error)
	// lotteryattemptledgerDescSourceType is the schema descriptor for source_type field.
	lotteryattemptledgerDescSourceType := lotteryattemptledgerFields[3].Descriptor()
	// lotteryattemptledger.SourceTypeValidator is a validator for the "source_type" field. It is called by the builders before save.
	lotteryattemptledger.SourceTypeValidator = func() func(string) error {
		validators := lotteryattemptledgerDescSourceType.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// lotteryattemptledgerDescSourceID is the schema descriptor for source_id field.
	lotteryattemptledgerDescSourceID := lotteryattemptledgerFields[4].Descriptor()
	// lotteryattemptledger.SourceIDValidator is a validator for the "source_id" field. It is called by the builders before save.
	lotteryattemptledger.SourceIDValidator = lotteryattemptledgerDescSourceID.Validators[0].(func(int64) error)
	// lotteryattemptledgerDescDescription is the schema descriptor for description field.
	lotteryattemptledgerDescDescription := lotteryattemptledgerFields[5].Descriptor()
	// lotteryattemptledger.DefaultDescription holds the default value on creation for the description field.
	lotteryattemptledger.DefaultDescription = lotteryattemptledgerDescDescription.Default.(string)
	// lotteryattemptledgerDescCreatedAt is the schema descriptor for created_at field.
	lotteryattemptledgerDescCreatedAt := lotteryattemptledgerFields[6].Descriptor()
	// lotteryattemptledger.DefaultCreatedAt holds the default value on creation for the created_at field.
	lotteryattemptledger.DefaultCreatedAt = lotteryattemptledgerDescCreatedAt.Default.(func() time.Time)
	lotteryattemptwalletFields := schema.LotteryAttemptWallet{}.Fields()
	_ = lotteryattemptwalletFields
	// lotteryattemptwalletDescBalance is the schema descriptor for balance field.
	lotteryattemptwalletDescBalance := lotteryattemptwalletFields[1].Descriptor()
	// lotteryattemptwallet.DefaultBalance holds the default value on creation for the balance field.
	lotteryattemptwallet.DefaultBalance = lotteryattemptwalletDescBalance.Default.(int)
	// lotteryattemptwallet.BalanceValidator is a validator for the "balance" field. It is called by the builders before save.
	lotteryattemptwallet.BalanceValidator = lotteryattemptwalletDescBalance.Validators[0].(func(int) error)
	// lotteryattemptwalletDescCreatedAt is the schema descriptor for created_at field.
	lotteryattemptwalletDescCreatedAt := lotteryattemptwalletFields[2].Descriptor()
	// lotteryattemptwallet.DefaultCreatedAt holds the default value on creation for the created_at field.
	lotteryattemptwallet.DefaultCreatedAt = lotteryattemptwalletDescCreatedAt.Default.(func() time.Time)
	// lotteryattemptwalletDescUpdatedAt is the schema descriptor for updated_at field.
	lotteryattemptwalletDescUpdatedAt := lotteryattemptwalletFields[3].Descriptor()
	// lotteryattemptwallet.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	lotteryattemptwallet.DefaultUpdatedAt = lotteryattemptwalletDescUpdatedAt.Default.(func() time.Time)
	// lotteryattemptwallet.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	lotteryattemptwallet.UpdateDefaultUpdatedAt = lotteryattemptwalletDescUpdatedAt.UpdateDefault.(func() time.Time)
	...
	// lotterydrawDescAttemptSource is the schema descriptor for attempt_source field.
	lotterydrawDescAttemptSource := lotterydrawFields[8].Descriptor()
	// lotterydraw.DefaultAttemptSource holds the default value on creation for the attempt_source field.
	lotterydraw.DefaultAttemptSource = lotterydrawDescAttemptSource.Default.(string)
	// lotterydraw.AttemptSourceValidator is a validator for the "attempt_source" field. It is called by the builders before save.
	lotterydraw.AttemptSourceValidator = func() func(string) error {
		validators := lotterydrawDescAttemptSource.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(attempt_source string) error {
			for _, fn := range fns {
				if err := fn(attempt_source); err != nil {
					return err
				}
			}
			return nil
	...
	lotterydrawDescCreatedAt := lotterydrawFields[9].Descriptor()
	...
	systemcustomgroupmodelFields := schema.SystemCustomGroupModel{}.Fields()
	_ = systemcustomgroupmodelFields
	// systemcustomgroupmodelDescPublicModel is the schema descriptor for public_model field.
	systemcustomgroupmodelDescPublicModel := systemcustomgroupmodelFields[1].Descriptor()
	// systemcustomgroupmodel.PublicModelValidator is a validator for the "public_model" field. It is called by the builders before save.
	systemcustomgroupmodel.PublicModelValidator = func() func(string) error {
		validators := systemcustomgroupmodelDescPublicModel.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// systemcustomgroupmodelDescSourceModel is the schema descriptor for source_model field.
	systemcustomgroupmodelDescSourceModel := systemcustomgroupmodelFields[3].Descriptor()
	// systemcustomgroupmodel.SourceModelValidator is a validator for the "source_model" field. It is called by the builders before save.
	systemcustomgroupmodel.SourceModelValidator = func() func(string) error {
		validators := systemcustomgroupmodelDescSourceModel.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// systemcustomgroupmodelDescEnabled is the schema descriptor for enabled field.
	systemcustomgroupmodelDescEnabled := systemcustomgroupmodelFields[4].Descriptor()
	// systemcustomgroupmodel.DefaultEnabled holds the default value on creation for the enabled field.
	systemcustomgroupmodel.DefaultEnabled = systemcustomgroupmodelDescEnabled.Default.(bool)
	// systemcustomgroupmodelDescCreatedAt is the schema descriptor for created_at field.
	systemcustomgroupmodelDescCreatedAt := systemcustomgroupmodelFields[5].Descriptor()
	// systemcustomgroupmodel.DefaultCreatedAt holds the default value on creation for the created_at field.
	systemcustomgroupmodel.DefaultCreatedAt = systemcustomgroupmodelDescCreatedAt.Default.(func() time.Time)
	// systemcustomgroupmodelDescUpdatedAt is the schema descriptor for updated_at field.
	systemcustomgroupmodelDescUpdatedAt := systemcustomgroupmodelFields[6].Descriptor()
	// systemcustomgroupmodel.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	...
	_ = usageresponseoutcomeFields
	// usageresponseoutcomeDescRequestID is the schema descriptor for request_id field.
	usageresponseoutcomeDescRequestID := usageresponseoutcomeFields[1].Descriptor()
	// usageresponseoutcome.RequestIDValidator is a validator for the "request_id" field. It is called by the builders before save.
	usageresponseoutcome.RequestIDValidator = func() func(string) error {
		validators := usageresponseoutcomeDescRequestID.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// usageresponseoutcomeDescHTTPStatus is the schema descriptor for http_status field.
	usageresponseoutcomeDescHTTPStatus := usageresponseoutcomeFields[6].Descriptor()
	// usageresponseoutcome.DefaultHTTPStatus holds the default value on creation for the http_status field.
	usageresponseoutcome.DefaultHTTPStatus = usageresponseoutcomeDescHTTPStatus.Default.(int)
	// usageresponseoutcomeDescUpstreamStatus is the schema descriptor for upstream_status field.
	usageresponseoutcomeDescUpstreamStatus := usageresponseoutcomeFields[7].Descriptor()
	// usageresponseoutcome.DefaultUpstreamStatus holds the default value on creation for the upstream_status field.
	usageresponseoutcome.DefaultUpstreamStatus = usageresponseoutcomeDescUpstreamStatus.Default.(int)
	// usageresponseoutcomeDescHasText is the schema descriptor for has_text field.
	usageresponseoutcomeDescHasText := usageresponseoutcomeFields[8].Descriptor()
	// usageresponseoutcome.DefaultHasText holds the default value on creation for the has_text field.
	usageresponseoutcome.DefaultHasText = usageresponseoutcomeDescHasText.Default.(bool)
	// usageresponseoutcomeDescHasToolCall is the schema descriptor for has_tool_call field.
	usageresponseoutcomeDescHasToolCall := usageresponseoutcomeFields[9].Descriptor()
	// usageresponseoutcome.DefaultHasToolCall holds the default value on creation for the has_tool_call field.
	usageresponseoutcome.DefaultHasToolCall = usageresponseoutcomeDescHasToolCall.Default.(bool)
	// usageresponseoutcomeDescHasReasoning is the schema descriptor for has_reasoning field.
	usageresponseoutcomeDescHasReasoning := usageresponseoutcomeFields[10].Descriptor()
	// usageresponseoutcome.DefaultHasReasoning holds the default value on creation for the has_reasoning field.
	usageresponseoutcome.DefaultHasReasoning = usageresponseoutcomeDescHasReasoning.Default.(bool)
	// usageresponseoutcomeDescHasMedia is the schema descriptor for has_media field.
	usageresponseoutcomeDescHasMedia := usageresponseoutcomeFields[11].Descriptor()
	// usageresponseoutcome.DefaultHasMedia holds the default value on creation for the has_media field.
	usageresponseoutcome.DefaultHasMedia = usageresponseoutcomeDescHasMedia.Default.(bool)
	// usageresponseoutcomeDescOutputBytes is the schema descriptor for output_bytes field.
	usageresponseoutcomeDescOutputBytes := usageresponseoutcomeFields[12].Descriptor()
	// usageresponseoutcome.DefaultOutputBytes holds the default value on creation for the output_bytes field.
	usageresponseoutcome.DefaultOutputBytes = usageresponseoutcomeDescOutputBytes.Default.(int64)
	// usageresponseoutcomeDescEventCount is the schema descriptor for event_count field.
	usageresponseoutcomeDescEventCount := usageresponseoutcomeFields[13].Descriptor()
	// usageresponseoutcome.DefaultEventCount holds the default value on creation for the event_count field.
	usageresponseoutcome.DefaultEventCount = usageresponseoutcomeDescEventCount.Default.(int)
	// usageresponseoutcomeDescStreamCompleted is the schema descriptor for stream_completed field.
	usageresponseoutcomeDescStreamCompleted := usageresponseoutcomeFields[14].Descriptor()
	// usageresponseoutcome.DefaultStreamCompleted holds the default value on creation for the stream_completed field.
	usageresponseoutcome.DefaultStreamCompleted = usageresponseoutcomeDescStreamCompleted.Default.(bool)
	// usageresponseoutcomeDescFinishReason is the schema descriptor for finish_reason field.
	usageresponseoutcomeDescFinishReason := usageresponseoutcomeFields[15].Descriptor()
	// usageresponseoutcome.DefaultFinishReason holds the default value on creation for the finish_reason field.
	usageresponseoutcome.DefaultFinishReason = usageresponseoutcomeDescFinishReason.Default.(string)
	// usageresponseoutcome.FinishReasonValidator is a validator for the "finish_reason" field. It is called by the builders before save.
	usageresponseoutcome.FinishReasonValidator = usageresponseoutcomeDescFinishReason.Validators[0].(func(string) error)
	// usageresponseoutcomeDescDisconnectSource is the schema descriptor for disconnect_source field.
	usageresponseoutcomeDescDisconnectSource := usageresponseoutcomeFields[16].Descriptor()
	// usageresponseoutcome.DefaultDisconnectSource holds the default value on creation for the disconnect_source field.
	usageresponseoutcome.DefaultDisconnectSource = usageresponseoutcomeDescDisconnectSource.Default.(string)
	// usageresponseoutcome.DisconnectSourceValidator is a validator for the "disconnect_source" field. It is called by the builders before save.
	usageresponseoutcome.DisconnectSourceValidator = usageresponseoutcomeDescDisconnectSource.Validators[0].(func(string) error)
	// usageresponseoutcomeDescUpstreamErrorKind is the schema descriptor for upstream_error_kind field.
	usageresponseoutcomeDescUpstreamErrorKind := usageresponseoutcomeFields[17].Descriptor()
	// usageresponseoutcome.DefaultUpstreamErrorKind holds the default value on creation for the upstream_error_kind field.
	usageresponseoutcome.DefaultUpstreamErrorKind = usageresponseoutcomeDescUpstreamErrorKind.Default.(string)
	// usageresponseoutcome.UpstreamErrorKindValidator is a validator for the "upstream_error_kind" field. It is called by the builders before save.
	usageresponseoutcome.UpstreamErrorKindValidator = usageresponseoutcomeDescUpstreamErrorKind.Validators[0].(func(string) error)
	// usageresponseoutcomeDescCollectorVersion is the schema descriptor for collector_version field.
	usageresponseoutcomeDescCollectorVersion := usageresponseoutcomeFields[18].Descriptor()
	// usageresponseoutcome.DefaultCollectorVersion holds the default value on creation for the collector_version field.
	usageresponseoutcome.DefaultCollectorVersion = usageresponseoutcomeDescCollectorVersion.Default.(int16)
	// usageresponseoutcomeDescCreatedAt is the schema descriptor for created_at field.
	usageresponseoutcomeDescCreatedAt := usageresponseoutcomeFields[19].Descriptor()
	// usageresponseoutcome.DefaultCreatedAt holds the default value on creation for the created_at field.
	usageresponseoutcome.DefaultCreatedAt = usageresponseoutcomeDescCreatedAt.Default.(func() time.Time)
	...
	// usercheckinDescLotteryAttemptsReward is the schema descriptor for lottery_attempts_reward field.
	usercheckinDescLotteryAttemptsReward := usercheckinFields[9].Descriptor()
	// usercheckin.DefaultLotteryAttemptsReward holds the default value on creation for the lottery_attempts_reward field.
	usercheckin.DefaultLotteryAttemptsReward = usercheckinDescLotteryAttemptsReward.Default.(int)
	// usercheckin.LotteryAttemptsRewardValidator is a validator for the "lottery_attempts_reward" field. It is called by the builders before save.
	usercheckin.LotteryAttemptsRewardValidator = usercheckinDescLotteryAttemptsReward.Validators[0].(func(int) error)
	// usercheckinDescTotalRewardAmount is the schema descriptor for total_reward_amount field.
	usercheckinDescTotalRewardAmount := usercheckinFields[10].Descriptor()
	...
	usercheckinDescPreviousDayUsageAmount := usercheckinFields[11].Descriptor()
	...
	usercheckinDescUsageRebateAmount := usercheckinFields[12].Descriptor()
	...
	usercheckinDescRewardCapAdjustment := usercheckinFields[13].Descriptor()
	...
	usercheckinDescRewardCampaignName := usercheckinFields[15].Descriptor()
	...
	usercheckinDescRewardCampaignTiersSnapshot := usercheckinFields[16].Descriptor()
	...
	usercustomgroupMixin := schema.UserCustomGroup{}.Mixin()
	usercustomgroupMixinHooks1 := usercustomgroupMixin[1].Hooks()
	usercustomgroup.Hooks[0] = usercustomgroupMixinHooks1[0]
	usercustomgroupMixinInters1 := usercustomgroupMixin[1].Interceptors()
	usercustomgroup.Interceptors[0] = usercustomgroupMixinInters1[0]
	usercustomgroupMixinFields0 := usercustomgroupMixin[0].Fields()
	_ = usercustomgroupMixinFields0
	usercustomgroupFields := schema.UserCustomGroup{}.Fields()
	_ = usercustomgroupFields
	// usercustomgroupDescCreatedAt is the schema descriptor for created_at field.
	usercustomgroupDescCreatedAt := usercustomgroupMixinFields0[0].Descriptor()
	// usercustomgroup.DefaultCreatedAt holds the default value on creation for the created_at field.
	usercustomgroup.DefaultCreatedAt = usercustomgroupDescCreatedAt.Default.(func() time.Time)
	// usercustomgroupDescUpdatedAt is the schema descriptor for updated_at field.
	usercustomgroupDescUpdatedAt := usercustomgroupMixinFields0[1].Descriptor()
	// usercustomgroup.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	usercustomgroup.DefaultUpdatedAt = usercustomgroupDescUpdatedAt.Default.(func() time.Time)
	// usercustomgroup.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	usercustomgroup.UpdateDefaultUpdatedAt = usercustomgroupDescUpdatedAt.UpdateDefault.(func() time.Time)
	// usercustomgroupDescName is the schema descriptor for name field.
	usercustomgroupDescName := usercustomgroupFields[1].Descriptor()
	// usercustomgroup.NameValidator is a validator for the "name" field. It is called by the builders before save.
	usercustomgroup.NameValidator = func() func(string) error {
		validators := usercustomgroupDescName.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// usercustomgroupDescStatus is the schema descriptor for status field.
	usercustomgroupDescStatus := usercustomgroupFields[2].Descriptor()
	// usercustomgroup.DefaultStatus holds the default value on creation for the status field.
	usercustomgroup.DefaultStatus = usercustomgroupDescStatus.Default.(string)
	// usercustomgroup.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	usercustomgroup.StatusValidator = usercustomgroupDescStatus.Validators[0].(func(string) error)
	usercustomgroupmodelFields := schema.UserCustomGroupModel{}.Fields()
	_ = usercustomgroupmodelFields
	// usercustomgroupmodelDescPublicModel is the schema descriptor for public_model field.
	usercustomgroupmodelDescPublicModel := usercustomgroupmodelFields[1].Descriptor()
	// usercustomgroupmodel.PublicModelValidator is a validator for the "public_model" field. It is called by the builders before save.
	usercustomgroupmodel.PublicModelValidator = func() func(string) error {
		validators := usercustomgroupmodelDescPublicModel.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// usercustomgroupmodelDescSourceModel is the schema descriptor for source_model field.
	usercustomgroupmodelDescSourceModel := usercustomgroupmodelFields[3].Descriptor()
	// usercustomgroupmodel.SourceModelValidator is a validator for the "source_model" field. It is called by the builders before save.
	usercustomgroupmodel.SourceModelValidator = func() func(string) error {
		validators := usercustomgroupmodelDescSourceModel.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// usercustomgroupmodelDescCreatedAt is the schema descriptor for created_at field.
	usercustomgroupmodelDescCreatedAt := usercustomgroupmodelFields[4].Descriptor()
	// usercustomgroupmodel.DefaultCreatedAt holds the default value on creation for the created_at field.
	usercustomgroupmodel.DefaultCreatedAt = usercustomgroupmodelDescCreatedAt.Default.(func() time.Time)
	// usercustomgroupmodelDescUpdatedAt is the schema descriptor for updated_at field.
	usercustomgroupmodelDescUpdatedAt := usercustomgroupmodelFields[5].Descriptor()
	// usercustomgroupmodel.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	usercustomgroupmodel.DefaultUpdatedAt = usercustomgroupmodelDescUpdatedAt.Default.(func() time.Time)
	// usercustomgroupmodel.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	usercustomgroupmodel.UpdateDefaultUpdatedAt = usercustomgroupmodelDescUpdatedAt.UpdateDefault.(func() time.Time)
