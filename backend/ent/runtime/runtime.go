...
func init() {
	...
	groupDescEmptyResponseCompensationEnabled := groupFields[4].Descriptor()
	...
	groupDescSystemCustomRoutingEnabled := groupFields[14].Descriptor()
	...
	groupDescDefaultReasoningEffort := groupFields[44].Descriptor()
	...
	groupDescSimulateClaudeMaxEnabled := groupFields[57].Descriptor()
