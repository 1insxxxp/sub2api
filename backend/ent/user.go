...
type User struct {
	...
	// Available balance excluded from eligibility thresholds
	GiftBalance float64 `json:"gift_balance,omitempty"`
	// Gift balance reserved for asynchronous usage holds
	...
	// RegistrationUserAgent holds the value of the "registration_user_agent" field.
	...
	// BalanceRedeemCodeEnabled holds the value of the "balance_redeem_code_enabled" field.
	BalanceRedeemCodeEnabled bool `json:"balance_redeem_code_enabled,omitempty"`
...
type UserEdges struct {
	...
	// CustomGroups holds the value of the custom_groups edge.
	CustomGroups []*UserCustomGroup `json:"custom_groups,omitempty"`
...
// CustomGroupsOrErr returns the CustomGroups value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) CustomGroupsOrErr() ([]*UserCustomGroup, error) {
	if e.loadedTypes[1] {
		return e.CustomGroups, nil
	}
	return nil, &NotLoadedError{edge: "custom_groups"}
}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldTotpEnabled, user.FieldRestrictPublicGroups, user.FieldBalanceNotifyEnabled, user.FieldBalanceRedeemCodeEnabled:
			values[i] = new(sql.NullBool)
		case user.FieldBalance, user.FieldFrozenBalance, user.FieldGiftBalance, user.FieldFrozenGiftBalance, user.FieldBalanceNotifyThreshold, user.FieldTotalRecharged:
			values[i] = new(sql.NullFloat64)
		case user.FieldID, user.FieldConcurrency, user.FieldRpmLimit:
			values[i] = new(sql.NullInt64)
		case user.FieldEmail, user.FieldPasswordHash, user.FieldRole, user.FieldStatus, user.FieldUsername, user.FieldNotes, user.FieldTotpSecretEncrypted, user.FieldSignupSource, user.FieldRegistrationIP, user.FieldRegistrationUserAgent, user.FieldLastLoginIP, user.FieldLastLoginUserAgent, user.FieldBalanceNotifyThresholdType, user.FieldBalanceNotifyExtraEmails:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldRegistrationUserAgent:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field registration_user_agent", values[i])
			} else if value.Valid {
				_m.RegistrationUserAgent = value.String
			}
		...
		case user.FieldBalanceRedeemCodeEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field balance_redeem_code_enabled", values[i])
			} else if value.Valid {
				_m.BalanceRedeemCodeEnabled = value.Bool
			}
		default:
...
// QueryCustomGroups queries the "custom_groups" edge of the User entity.
func (_m *User) QueryCustomGroups() *UserCustomGroupQuery {
	return NewUserClient(_m.config).QueryCustomGroups(_m)
}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("registration_user_agent=")
	builder.WriteString(_m.RegistrationUserAgent)
	builder.WriteString(", ")
	builder.WriteString("last_login_ip=")
	builder.WriteString(_m.LastLoginIP)
	builder.WriteString(", ")
	builder.WriteString("last_login_user_agent=")
	builder.WriteString(_m.LastLoginUserAgent)
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("balance_redeem_code_enabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.BalanceRedeemCodeEnabled))
	builder.WriteByte(')')
