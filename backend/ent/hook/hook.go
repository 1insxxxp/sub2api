...
// The CheckinRewardCampaignFunc type is an adapter to allow the use of ordinary
// function as CheckinRewardCampaign mutator.
type CheckinRewardCampaignFunc func(context.Context, *ent.CheckinRewardCampaignMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CheckinRewardCampaignFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CheckinRewardCampaignMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CheckinRewardCampaignMutation", m)
}
...
// The LotteryAttemptGrantFunc type is an adapter to allow the use of ordinary
// function as LotteryAttemptGrant mutator.
type LotteryAttemptGrantFunc func(context.Context, *ent.LotteryAttemptGrantMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LotteryAttemptGrantFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.LotteryAttemptGrantMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.LotteryAttemptGrantMutation", m)
}

// The LotteryAttemptLedgerFunc type is an adapter to allow the use of ordinary
// function as LotteryAttemptLedger mutator.
type LotteryAttemptLedgerFunc func(context.Context, *ent.LotteryAttemptLedgerMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LotteryAttemptLedgerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.LotteryAttemptLedgerMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.LotteryAttemptLedgerMutation", m)
}

// The LotteryAttemptWalletFunc type is an adapter to allow the use of ordinary
// function as LotteryAttemptWallet mutator.
type LotteryAttemptWalletFunc func(context.Context, *ent.LotteryAttemptWalletMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LotteryAttemptWalletFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.LotteryAttemptWalletMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.LotteryAttemptWalletMutation", m)
}
...
// The SystemCustomGroupModelFunc type is an adapter to allow the use of ordinary
// function as SystemCustomGroupModel mutator.
type SystemCustomGroupModelFunc func(context.Context, *ent.SystemCustomGroupModelMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SystemCustomGroupModelFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SystemCustomGroupModelMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f UserImageFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserImageMutation); ok {
		return f(ctx, mv)
	}
