...
// The UserCheckinStatusSnapshotFunc type is an adapter to allow the use of ordinary function as a Querier.
type UserCheckinStatusSnapshotFunc func(context.Context, *ent.UserCheckinStatusSnapshotQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f UserCheckinStatusSnapshotFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.UserCheckinStatusSnapshotQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.UserCheckinStatusSnapshotQuery", q)
}

// The TraverseUserCheckinStatusSnapshot type is an adapter to allow the use of ordinary function as Traverser.
type TraverseUserCheckinStatusSnapshot func(context.Context, *ent.UserCheckinStatusSnapshotQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseUserCheckinStatusSnapshot) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseUserCheckinStatusSnapshot) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.UserCheckinStatusSnapshotQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.UserCheckinStatusSnapshotQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.UserCheckinStatusSnapshotQuery:
		return &query[*ent.UserCheckinStatusSnapshotQuery, predicate.UserCheckinStatusSnapshot, usercheckinstatussnapshot.OrderOption]{typ: ent.TypeUserCheckinStatusSnapshot, tq: q}, nil
