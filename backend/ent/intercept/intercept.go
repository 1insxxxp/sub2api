...
// The RedeemBatchClaimFunc type is an adapter to allow the use of ordinary function as a Querier.
type RedeemBatchClaimFunc func(context.Context, *ent.RedeemBatchClaimQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f RedeemBatchClaimFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.RedeemBatchClaimQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.RedeemBatchClaimQuery", q)
}

// The TraverseRedeemBatchClaim type is an adapter to allow the use of ordinary function as Traverser.
type TraverseRedeemBatchClaim func(context.Context, *ent.RedeemBatchClaimQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseRedeemBatchClaim) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseRedeemBatchClaim) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.RedeemBatchClaimQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.RedeemBatchClaimQuery", q)
}
...
// The SystemCustomGroupModelFunc type is an adapter to allow the use of ordinary function as a Querier.
type SystemCustomGroupModelFunc func(context.Context, *ent.SystemCustomGroupModelQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SystemCustomGroupModelFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SystemCustomGroupModelQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SystemCustomGroupModelQuery", q)
}

// The TraverseSystemCustomGroupModel type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSystemCustomGroupModel func(context.Context, *ent.SystemCustomGroupModelQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSystemCustomGroupModel) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSystemCustomGroupModel) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SystemCustomGroupModelQuery); ok {
		return f(ctx, q)
	}
...
// Query calls f(ctx, q).
func (f UserImageFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.UserImageQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.UserImageQuery", q)
}

// The TraverseUserImage type is an adapter to allow the use of ordinary function as Traverser.
type TraverseUserImage func(context.Context, *ent.UserImageQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseUserImage) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseUserImage) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.UserImageQuery); ok {
		return f(ctx, q)
	}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.RedeemBatchClaimQuery:
		return &query[*ent.RedeemBatchClaimQuery, predicate.RedeemBatchClaim, redeembatchclaim.OrderOption]{typ: ent.TypeRedeemBatchClaim, tq: q}, nil
