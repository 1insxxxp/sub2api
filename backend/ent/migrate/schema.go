...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "model_system_prompts", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "model_mappings", Type: field.TypeJSON},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "tag", Type: field.TypeString, Size: 80, Default: ""},
		{Name: "tag_color", Type: field.TypeString, Size: 7, Default: ""},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		...
		{Name: "default_reasoning_effort", Type: field.TypeString, Size: 20, Default: ""},
		...
		{Name: "model_status_visibility", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	RedeemCodesColumns = []*schema.Column{
		...
		{Name: "threshold_exempt", Type: field.TypeBool, Default: false},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "threshold_exempt_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "registration_user_agent", Type: field.TypeString, Default: "", SchemaType: map[string]string{"postgres": "text"}},
		{Name: "last_login_ip", Type: field.TypeString, Size: 64, Default: ""},
		{Name: "last_login_user_agent", Type: field.TypeString, Default: "", SchemaType: map[string]string{"postgres": "text"}},
