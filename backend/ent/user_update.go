...
func (_u *UserUpdate) AddCheckinStatusSnapshotIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddCheckinStatusSnapshotIDs(ids...)
	return _u
}

// AddCheckinStatusSnapshots adds the "checkin_status_snapshots" edges to the UserCheckinStatusSnapshot entity.
func (_u *UserUpdate) AddCheckinStatusSnapshots(v ...*UserCheckinStatusSnapshot) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddCheckinStatusSnapshotIDs(ids...)
}
...
// ClearCheckinStatusSnapshots clears all "checkin_status_snapshots" edges to the UserCheckinStatusSnapshot entity.
func (_u *UserUpdate) ClearCheckinStatusSnapshots() *UserUpdate {
	_u.mutation.ClearCheckinStatusSnapshots()
	return _u
}

// RemoveCheckinStatusSnapshotIDs removes the "checkin_status_snapshots" edge to UserCheckinStatusSnapshot entities by IDs.
func (_u *UserUpdate) RemoveCheckinStatusSnapshotIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveCheckinStatusSnapshotIDs(ids...)
	return _u
}

// RemoveCheckinStatusSnapshots removes "checkin_status_snapshots" edges to UserCheckinStatusSnapshot entities.
func (_u *UserUpdate) RemoveCheckinStatusSnapshots(v ...*UserCheckinStatusSnapshot) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveCheckinStatusSnapshotIDs(ids...)
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.CheckinStatusSnapshotsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedCheckinStatusSnapshotsIDs(); len(nodes) > 0 && !_u.mutation.CheckinStatusSnapshotsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.CheckinStatusSnapshotsTable,
	...
	if nodes := _u.mutation.CheckinStatusSnapshotsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.CheckinStatusSnapshotsTable,
...
// AddCheckinStatusSnapshotIDs adds the "checkin_status_snapshots" edge to the UserCheckinStatusSnapshot entity by IDs.
func (_u *UserUpdateOne) AddCheckinStatusSnapshotIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddCheckinStatusSnapshotIDs(ids...)
	return _u
}

// AddCheckinStatusSnapshots adds the "checkin_status_snapshots" edges to the UserCheckinStatusSnapshot entity.
func (_u *UserUpdateOne) AddCheckinStatusSnapshots(v ...*UserCheckinStatusSnapshot) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearCheckinStatusSnapshots clears all "checkin_status_snapshots" edges to the UserCheckinStatusSnapshot entity.
func (_u *UserUpdateOne) ClearCheckinStatusSnapshots() *UserUpdateOne {
	_u.mutation.ClearCheckinStatusSnapshots()
	return _u
}

// RemoveCheckinStatusSnapshotIDs removes the "checkin_status_snapshots" edge to UserCheckinStatusSnapshot entities by IDs.
func (_u *UserUpdateOne) RemoveCheckinStatusSnapshotIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveCheckinStatusSnapshotIDs(ids...)
	return _u
}

// RemoveCheckinStatusSnapshots removes "checkin_status_snapshots" edges to UserCheckinStatusSnapshot entities.
func (_u *UserUpdateOne) RemoveCheckinStatusSnapshots(v ...*UserCheckinStatusSnapshot) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
