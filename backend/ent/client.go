...
type Client struct {
	...
	// LotteryAttemptGrant is the client for interacting with the LotteryAttemptGrant builders.
	LotteryAttemptGrant *LotteryAttemptGrantClient
...
func (c *Client) init() {
	...
	c.LotteryAttemptGrant = NewLotteryAttemptGrantClient(c.config)
	...
	c.SystemCustomGroupSource = NewSystemCustomGroupSourceClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		LotteryAttemptGrant:           NewLotteryAttemptGrantClient(cfg),
		...
		SystemCustomGroupSource:       NewSystemCustomGroupSourceClient(cfg),
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.IdentityAdoptionDecision, c.LotteryActivity, c.LotteryAttemptGrant,
		c.LotteryAttemptLedger, c.LotteryAttemptWallet, c.LotteryDraw, c.LotteryPrize,
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *LotteryAttemptGrantMutation:
		return c.LotteryAttemptGrant.mutate(ctx, m)
	...
	case *LotteryPrizeItemMutation:
		return c.LotteryPrizeItem.mutate(ctx, m)
	...
	case *SystemCustomGroupSourceMutation:
		return c.SystemCustomGroupSource.mutate(ctx, m)
...
// QuerySystemCustomSources queries the system_custom_sources edge of a Group.
func (c *GroupClient) QuerySystemCustomSources(_m *Group) *SystemCustomGroupSourceQuery {
	query := (&SystemCustomGroupSourceClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(group.Table, group.FieldID, id),
...
// QuerySystemCustomSourceReferences queries the system_custom_source_references edge of a Group.
func (c *GroupClient) QuerySystemCustomSourceReferences(_m *Group) *SystemCustomGroupSourceQuery {
	query := (&SystemCustomGroupSourceClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryPrizes queries the prizes edge of a LotteryActivity.
func (c *LotteryActivityClient) QueryPrizes(_m *LotteryActivity) *LotteryPrizeQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, lotteryactivity.PrizesTable, lotteryactivity.PrizesColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryDraws queries the draws edge of a LotteryActivity.
func (c *LotteryActivityClient) QueryDraws(_m *LotteryActivity) *LotteryDrawQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, lotteryactivity.DrawsTable, lotteryactivity.DrawsColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// LotteryAttemptGrantClient is a client for the LotteryAttemptGrant schema.
type LotteryAttemptGrantClient struct {
	config
}

// NewLotteryAttemptGrantClient returns a client for the LotteryAttemptGrant from the given config.
func NewLotteryAttemptGrantClient(c config) *LotteryAttemptGrantClient {
	return &LotteryAttemptGrantClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lotteryattemptgrant.Hooks(f(g(h())))`.
func (c *LotteryAttemptGrantClient) Use(hooks ...Hook) {
	c.hooks.LotteryAttemptGrant = append(c.hooks.LotteryAttemptGrant, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lotteryattemptgrant.Intercept(f(g(h())))`.
func (c *LotteryAttemptGrantClient) Intercept(interceptors ...Interceptor) {
	c.inters.LotteryAttemptGrant = append(c.inters.LotteryAttemptGrant, interceptors...)
}

// Create returns a builder for creating a LotteryAttemptGrant entity.
func (c *LotteryAttemptGrantClient) Create() *LotteryAttemptGrantCreate {
	mutation := newLotteryAttemptGrantMutation(c.config, OpCreate)
	return &LotteryAttemptGrantCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LotteryAttemptGrant entities.
func (c *LotteryAttemptGrantClient) CreateBulk(builders ...*LotteryAttemptGrantCreate) *LotteryAttemptGrantCreateBulk {
	return &LotteryAttemptGrantCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LotteryAttemptGrantClient) MapCreateBulk(slice any, setFunc func(*LotteryAttemptGrantCreate, int)) *LotteryAttemptGrantCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LotteryAttemptGrantCreateBulk{err: fmt.Errorf("calling to LotteryAttemptGrantClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LotteryAttemptGrantCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LotteryAttemptGrant.
func (c *LotteryAttemptGrantClient) Update() *LotteryAttemptGrantUpdate {
	mutation := newLotteryAttemptGrantMutation(c.config, OpUpdate)
	return &LotteryAttemptGrantUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LotteryAttemptGrantClient) UpdateOne(_m *LotteryAttemptGrant) *LotteryAttemptGrantUpdateOne {
	mutation := newLotteryAttemptGrantMutation(c.config, OpUpdateOne, withLotteryAttemptGrant(_m))
	return &LotteryAttemptGrantUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LotteryAttemptGrantClient) UpdateOneID(id int64) *LotteryAttemptGrantUpdateOne {
	mutation := newLotteryAttemptGrantMutation(c.config, OpUpdateOne, withLotteryAttemptGrantID(id))
	return &LotteryAttemptGrantUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LotteryAttemptGrant.
func (c *LotteryAttemptGrantClient) Delete() *LotteryAttemptGrantDelete {
	mutation := newLotteryAttemptGrantMutation(c.config, OpDelete)
	return &LotteryAttemptGrantDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LotteryAttemptGrantClient) DeleteOne(_m *LotteryAttemptGrant) *LotteryAttemptGrantDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LotteryAttemptGrantClient) DeleteOneID(id int64) *LotteryAttemptGrantDeleteOne {
	builder := c.Delete().Where(lotteryattemptgrant.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LotteryAttemptGrantDeleteOne{builder}
}

// Query returns a query builder for LotteryAttemptGrant.
func (c *LotteryAttemptGrantClient) Query() *LotteryAttemptGrantQuery {
	return &LotteryAttemptGrantQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLotteryAttemptGrant},
		inters: c.Interceptors(),
	}
}

// Get returns a LotteryAttemptGrant entity by its id.
func (c *LotteryAttemptGrantClient) Get(ctx context.Context, id int64) (*LotteryAttemptGrant, error) {
	return c.Query().Where(lotteryattemptgrant.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LotteryAttemptGrantClient) GetX(ctx context.Context, id int64) *LotteryAttemptGrant {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LotteryAttemptGrantClient) Hooks() []Hook {
	return c.hooks.LotteryAttemptGrant
}

// Interceptors returns the client interceptors.
func (c *LotteryAttemptGrantClient) Interceptors() []Interceptor {
	return c.inters.LotteryAttemptGrant
}

func (c *LotteryAttemptGrantClient) mutate(ctx context.Context, m *LotteryAttemptGrantMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LotteryAttemptGrantCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LotteryAttemptGrantUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LotteryAttemptGrantUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LotteryAttemptGrantDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown LotteryAttemptGrant mutation op: %q", m.Op())
	}
}
...
// QueryActivity queries the activity edge of a LotteryDraw.
func (c *LotteryDrawClient) QueryActivity(_m *LotteryDraw) *LotteryActivityQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, lotterydraw.ActivityTable, lotterydraw.ActivityColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryActivity queries the activity edge of a LotteryPrize.
func (c *LotteryPrizeClient) QueryActivity(_m *LotteryPrize) *LotteryActivityQuery {
	query := (&LotteryActivityClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(lotteryactivity.Table, lotteryactivity.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, lotteryprize.ActivityTable, lotteryprize.ActivityColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryItems queries the items edge of a LotteryPrize.
func (c *LotteryPrizeClient) QueryItems(_m *LotteryPrize) *LotteryPrizeItemQuery {
	query := (&LotteryPrizeItemClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(lotteryprize.Table, lotteryprize.FieldID, id),
			sqlgraph.To(lotteryprizeitem.Table, lotteryprizeitem.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, lotteryprize.ItemsTable, lotteryprize.ItemsColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// LotteryPrizeItemClient is a client for the LotteryPrizeItem schema.
type LotteryPrizeItemClient struct {
	config
}

// NewLotteryPrizeItemClient returns a client for the LotteryPrizeItem from the given config.
func NewLotteryPrizeItemClient(c config) *LotteryPrizeItemClient {
	return &LotteryPrizeItemClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lotteryprizeitem.Hooks(f(g(h())))`.
func (c *LotteryPrizeItemClient) Use(hooks ...Hook) {
	c.hooks.LotteryPrizeItem = append(c.hooks.LotteryPrizeItem, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lotteryprizeitem.Intercept(f(g(h())))`.
func (c *LotteryPrizeItemClient) Intercept(interceptors ...Interceptor) {
	c.inters.LotteryPrizeItem = append(c.inters.LotteryPrizeItem, interceptors...)
}

// Create returns a builder for creating a LotteryPrizeItem entity.
func (c *LotteryPrizeItemClient) Create() *LotteryPrizeItemCreate {
	mutation := newLotteryPrizeItemMutation(c.config, OpCreate)
	return &LotteryPrizeItemCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LotteryPrizeItem entities.
func (c *LotteryPrizeItemClient) CreateBulk(builders ...*LotteryPrizeItemCreate) *LotteryPrizeItemCreateBulk {
	return &LotteryPrizeItemCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LotteryPrizeItemClient) MapCreateBulk(slice any, setFunc func(*LotteryPrizeItemCreate, int)) *LotteryPrizeItemCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LotteryPrizeItemCreateBulk{err: fmt.Errorf("calling to LotteryPrizeItemClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LotteryPrizeItemCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LotteryPrizeItem.
func (c *LotteryPrizeItemClient) Update() *LotteryPrizeItemUpdate {
	mutation := newLotteryPrizeItemMutation(c.config, OpUpdate)
	return &LotteryPrizeItemUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LotteryPrizeItemClient) UpdateOne(_m *LotteryPrizeItem) *LotteryPrizeItemUpdateOne {
	mutation := newLotteryPrizeItemMutation(c.config, OpUpdateOne, withLotteryPrizeItem(_m))
	return &LotteryPrizeItemUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LotteryPrizeItemClient) UpdateOneID(id int64) *LotteryPrizeItemUpdateOne {
	mutation := newLotteryPrizeItemMutation(c.config, OpUpdateOne, withLotteryPrizeItemID(id))
	return &LotteryPrizeItemUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LotteryPrizeItem.
func (c *LotteryPrizeItemClient) Delete() *LotteryPrizeItemDelete {
	mutation := newLotteryPrizeItemMutation(c.config, OpDelete)
	return &LotteryPrizeItemDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LotteryPrizeItemClient) DeleteOne(_m *LotteryPrizeItem) *LotteryPrizeItemDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LotteryPrizeItemClient) DeleteOneID(id int64) *LotteryPrizeItemDeleteOne {
	builder := c.Delete().Where(lotteryprizeitem.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LotteryPrizeItemDeleteOne{builder}
}

// Query returns a query builder for LotteryPrizeItem.
func (c *LotteryPrizeItemClient) Query() *LotteryPrizeItemQuery {
	return &LotteryPrizeItemQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLotteryPrizeItem},
		inters: c.Interceptors(),
	}
}

// Get returns a LotteryPrizeItem entity by its id.
func (c *LotteryPrizeItemClient) Get(ctx context.Context, id int64) (*LotteryPrizeItem, error) {
	return c.Query().Where(lotteryprizeitem.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LotteryPrizeItemClient) GetX(ctx context.Context, id int64) *LotteryPrizeItem {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryPrize queries the prize edge of a LotteryPrizeItem.
func (c *LotteryPrizeItemClient) QueryPrize(_m *LotteryPrizeItem) *LotteryPrizeQuery {
	query := (&LotteryPrizeClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(lotteryprizeitem.Table, lotteryprizeitem.FieldID, id),
			sqlgraph.To(lotteryprize.Table, lotteryprize.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, lotteryprizeitem.PrizeTable, lotteryprizeitem.PrizeColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// Hooks returns the client hooks.
func (c *LotteryPrizeItemClient) Hooks() []Hook {
	return c.hooks.LotteryPrizeItem
}

// Interceptors returns the client interceptors.
func (c *LotteryPrizeItemClient) Interceptors() []Interceptor {
	return c.inters.LotteryPrizeItem
}

func (c *LotteryPrizeItemClient) mutate(ctx context.Context, m *LotteryPrizeItemMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LotteryPrizeItemCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LotteryPrizeItemUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LotteryPrizeItemUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LotteryPrizeItemDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown LotteryPrizeItem mutation op: %q", m.Op())
	}
}
...
// SystemCustomGroupSourceClient is a client for the SystemCustomGroupSource schema.
type SystemCustomGroupSourceClient struct {
	config
}

// NewSystemCustomGroupSourceClient returns a client for the SystemCustomGroupSource from the given config.
func NewSystemCustomGroupSourceClient(c config) *SystemCustomGroupSourceClient {
	return &SystemCustomGroupSourceClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `systemcustomgroupsource.Hooks(f(g(h())))`.
func (c *SystemCustomGroupSourceClient) Use(hooks ...Hook) {
	c.hooks.SystemCustomGroupSource = append(c.hooks.SystemCustomGroupSource, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `systemcustomgroupsource.Intercept(f(g(h())))`.
func (c *SystemCustomGroupSourceClient) Intercept(interceptors ...Interceptor) {
	c.inters.SystemCustomGroupSource = append(c.inters.SystemCustomGroupSource, interceptors...)
}

// Create returns a builder for creating a SystemCustomGroupSource entity.
func (c *SystemCustomGroupSourceClient) Create() *SystemCustomGroupSourceCreate {
	mutation := newSystemCustomGroupSourceMutation(c.config, OpCreate)
	return &SystemCustomGroupSourceCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of SystemCustomGroupSource entities.
func (c *SystemCustomGroupSourceClient) CreateBulk(builders ...*SystemCustomGroupSourceCreate) *SystemCustomGroupSourceCreateBulk {
	return &SystemCustomGroupSourceCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *SystemCustomGroupSourceClient) MapCreateBulk(slice any, setFunc func(*SystemCustomGroupSourceCreate, int)) *SystemCustomGroupSourceCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SystemCustomGroupSourceCreateBulk{err: fmt.Errorf("calling to SystemCustomGroupSourceClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*SystemCustomGroupSourceCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for SystemCustomGroupSource.
func (c *SystemCustomGroupSourceClient) Update() *SystemCustomGroupSourceUpdate {
	mutation := newSystemCustomGroupSourceMutation(c.config, OpUpdate)
	return &SystemCustomGroupSourceUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *SystemCustomGroupSourceClient) UpdateOne(_m *SystemCustomGroupSource) *SystemCustomGroupSourceUpdateOne {
	mutation := newSystemCustomGroupSourceMutation(c.config, OpUpdateOne, withSystemCustomGroupSource(_m))
	return &SystemCustomGroupSourceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *SystemCustomGroupSourceClient) UpdateOneID(id int64) *SystemCustomGroupSourceUpdateOne {
	mutation := newSystemCustomGroupSourceMutation(c.config, OpUpdateOne, withSystemCustomGroupSourceID(id))
	return &SystemCustomGroupSourceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for SystemCustomGroupSource.
func (c *SystemCustomGroupSourceClient) Delete() *SystemCustomGroupSourceDelete {
	mutation := newSystemCustomGroupSourceMutation(c.config, OpDelete)
	return &SystemCustomGroupSourceDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *SystemCustomGroupSourceClient) DeleteOne(_m *SystemCustomGroupSource) *SystemCustomGroupSourceDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *SystemCustomGroupSourceClient) DeleteOneID(id int64) *SystemCustomGroupSourceDeleteOne {
	builder := c.Delete().Where(systemcustomgroupsource.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &SystemCustomGroupSourceDeleteOne{builder}
}

// Query returns a query builder for SystemCustomGroupSource.
func (c *SystemCustomGroupSourceClient) Query() *SystemCustomGroupSourceQuery {
	return &SystemCustomGroupSourceQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeSystemCustomGroupSource},
		inters: c.Interceptors(),
	}
}

// Get returns a SystemCustomGroupSource entity by its id.
func (c *SystemCustomGroupSourceClient) Get(ctx context.Context, id int64) (*SystemCustomGroupSource, error) {
	return c.Query().Where(systemcustomgroupsource.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *SystemCustomGroupSourceClient) GetX(ctx context.Context, id int64) *SystemCustomGroupSource {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryGroup queries the group edge of a SystemCustomGroupSource.
func (c *SystemCustomGroupSourceClient) QueryGroup(_m *SystemCustomGroupSource) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(systemcustomgroupsource.Table, systemcustomgroupsource.FieldID, id),
			sqlgraph.To(group.Table, group.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, systemcustomgroupsource.GroupTable, systemcustomgroupsource.GroupColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QuerySourceGroup queries the source_group edge of a SystemCustomGroupSource.
func (c *SystemCustomGroupSourceClient) QuerySourceGroup(_m *SystemCustomGroupSource) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(systemcustomgroupsource.Table, systemcustomgroupsource.FieldID, id),
			sqlgraph.To(group.Table, group.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, systemcustomgroupsource.SourceGroupTable, systemcustomgroupsource.SourceGroupColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// Hooks returns the client hooks.
func (c *SystemCustomGroupSourceClient) Hooks() []Hook {
	return c.hooks.SystemCustomGroupSource
}

// Interceptors returns the client interceptors.
func (c *SystemCustomGroupSourceClient) Interceptors() []Interceptor {
	return c.inters.SystemCustomGroupSource
}

func (c *SystemCustomGroupSourceClient) mutate(ctx context.Context, m *SystemCustomGroupSourceMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&SystemCustomGroupSourceCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&SystemCustomGroupSourceUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&SystemCustomGroupSourceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&SystemCustomGroupSourceDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown SystemCustomGroupSource mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		...
		IdentityAdoptionDecision, LotteryActivity, LotteryAttemptGrant,
		LotteryAttemptLedger, LotteryAttemptWallet, LotteryDraw, LotteryPrize,
