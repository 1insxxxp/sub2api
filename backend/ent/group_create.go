...
func (_c *GroupCreate) SetModelStatusVisibility(v domain.GroupModelStatusVisibility) *GroupCreate {
	_c.mutation.SetModelStatusVisibility(v)
	return _c
}

// SetNillableModelStatusVisibility sets the "model_status_visibility" field if the given value is not nil.
func (_c *GroupCreate) SetNillableModelStatusVisibility(v *domain.GroupModelStatusVisibility) *GroupCreate {
	if v != nil {
		_c.SetModelStatusVisibility(*v)
	}
	return _c
}
...
func (_c *GroupCreate) AddCustomModelRouteIDs(ids ...int64) *GroupCreate {
	_c.mutation.AddCustomModelRouteIDs(ids...)
	return _c
}

// AddCustomModelRoutes adds the "custom_model_routes" edges to the UserCustomGroupModel entity.
func (_c *GroupCreate) AddCustomModelRoutes(v ...*UserCustomGroupModel) *GroupCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *GroupCreate) AddSystemCustomSourceIDs(ids ...int64) *GroupCreate {
	_c.mutation.AddSystemCustomSourceIDs(ids...)
	return _c
}

// AddSystemCustomSources adds the "system_custom_sources" edges to the SystemCustomGroupSource entity.
func (_c *GroupCreate) AddSystemCustomSources(v ...*SystemCustomGroupSource) *GroupCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddSystemCustomSourceIDs(ids...)
}
...
func (_c *GroupCreate) AddSystemCustomSourceReferenceIDs(ids ...int64) *GroupCreate {
	_c.mutation.AddSystemCustomSourceReferenceIDs(ids...)
	return _c
}

// AddSystemCustomSourceReferences adds the "system_custom_source_references" edges to the SystemCustomGroupSource entity.
func (_c *GroupCreate) AddSystemCustomSourceReferences(v ...*SystemCustomGroupSource) *GroupCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddSystemCustomSourceReferenceIDs(ids...)
}
...
func (_c *GroupCreate) defaults() error {
	...
	if _, ok := _c.mutation.ModelStatusVisibility(); !ok {
		v := group.DefaultModelStatusVisibility
		_c.mutation.SetModelStatusVisibility(v)
	}
...
func (_c *GroupCreate) check() error {
	...
	if _, ok := _c.mutation.ModelStatusVisibility(); !ok {
		return &ValidationError{Name: "model_status_visibility", err: errors.New(`ent: missing required field "Group.model_status_visibility"`)}
	}
	if _, ok := _c.mutation.CodexModelsManifestConfig(); !ok {
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.ModelStatusVisibility(); ok {
		_spec.SetField(group.FieldModelStatusVisibility, field.TypeJSON, value)
		_node.ModelStatusVisibility = value
	}
	...
	if nodes := _c.mutation.CustomModelRoutesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.SystemCustomSourcesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.SystemCustomSourceReferencesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
...
// SetModelStatusVisibility sets the "model_status_visibility" field.
func (u *GroupUpsert) SetModelStatusVisibility(v domain.GroupModelStatusVisibility) *GroupUpsert {
	u.Set(group.FieldModelStatusVisibility, v)
	return u
}

// UpdateModelStatusVisibility sets the "model_status_visibility" field to the value that was provided on create.
func (u *GroupUpsert) UpdateModelStatusVisibility() *GroupUpsert {
	u.SetExcluded(group.FieldModelStatusVisibility)
	return u
}
...
// SetModelStatusVisibility sets the "model_status_visibility" field.
func (u *GroupUpsertOne) SetModelStatusVisibility(v domain.GroupModelStatusVisibility) *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.SetModelStatusVisibility(v)
	})
}

// UpdateModelStatusVisibility sets the "model_status_visibility" field to the value that was provided on create.
func (u *GroupUpsertOne) UpdateModelStatusVisibility() *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateModelStatusVisibility()
	})
}
...
// SetModelStatusVisibility sets the "model_status_visibility" field.
func (u *GroupUpsertBulk) SetModelStatusVisibility(v domain.GroupModelStatusVisibility) *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.SetModelStatusVisibility(v)
	})
}
...
// UpdateModelStatusVisibility sets the "model_status_visibility" field to the value that was provided on create.
func (u *GroupUpsertBulk) UpdateModelStatusVisibility() *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateModelStatusVisibility()
	})
}
