...
// was not loaded in eager-loading, or loaded but was not found.
func (e APIKeyEdges) CustomGroupOrErr() (*UserCustomGroup, error) {
...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apikey.FieldID, apikey.FieldUserID, apikey.FieldGroupID, apikey.FieldCustomGroupID:
...
// QueryCustomGroup queries the "custom_group" edge of the APIKey entity.
func (_m *APIKey) QueryCustomGroup() *UserCustomGroupQuery {
	return NewAPIKeyClient(_m.config).QueryCustomGroup(_m)
}
