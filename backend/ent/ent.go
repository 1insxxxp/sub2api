...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			checkinrewardcampaign.Table:         checkinrewardcampaign.ValidColumn,
			compositemodelroute.Table:           compositemodelroute.ValidColumn,
			emptyresponseclaim.Table:            emptyresponseclaim.ValidColumn,
			errorpassthroughrule.Table:          errorpassthroughrule.ValidColumn,
			group.Table:                         group.ValidColumn,
			idempotencyrecord.Table:             idempotencyrecord.ValidColumn,
			identityadoptiondecision.Table:      identityadoptiondecision.ValidColumn,
			lotteryactivity.Table:               lotteryactivity.ValidColumn,
			lotteryattemptgrant.Table:           lotteryattemptgrant.ValidColumn,
			...
			redeembatchclaim.Table:              redeembatchclaim.ValidColumn,
			...
			usageresponseoutcome.Table:          usageresponseoutcome.ValidColumn,
