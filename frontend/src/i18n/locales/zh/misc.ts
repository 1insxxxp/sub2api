export default {
  ...
  payment: {
    ...
    rechargeOfferTitle: '充值优惠',
    rechargeOfferHint: '选择快捷金额后，到账余额和赠送额度会按当前规则自动计算。',
    rechargeOfferAmount: '充值金额',
    rechargeOfferCredit: '到账余额',
    rechargeOfferBonus: '赠送',
    rechargeOfferIncludedHint: '到账合计已包含赠送额度，赠送不会重复叠加。',
    rechargeOfferCreditTotal: '到账合计',
    rechargeOfferBase: '基础',
    rechargeOfferBonusIncluded: '其中赠送',
    rechargePromotionBadge: '限时活动',
