export default {
    ...
    redeem: {
      ...
      singleUsePerUser: '活动兑换码，一人限用一次',
      singleUsePerUserHint: '本次生成的兑换码属于同一批次，每个账号只能兑换其中一张。',
      singleUseBadge: '一人限用一次',
    ...
    usage: {
      ...
      emptyResponseClaims: {
        tab: '空回补偿列表',
        rate: '空回补偿率',
        warning: '当前空回补偿率为 {rate}，已达到 1% 关注阈值，请优先检查高排名账号和模型。',
        claims: '补偿记录数',
        refunded: '已补金额',
        pending: '待人工审核',
        allStatuses: '全部状态',
        selectPage: '全选当前页',
        clearPageSelection: '取消全选',
        ...
        lowOutputNotice: '该记录命中低输出规则：输出 Token 不超过 10，可结合请求时长、状态码和用户说明快速复核。',
