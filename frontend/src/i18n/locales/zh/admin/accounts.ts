export default {
    accounts: {
      ...
      refreshing: '刷新中...',
      noAccounts: '暂无账号',
      noAccountsDescription: '添加 AI 平台账号后即可使用 API 网关。',
      ...
      modelSystemPromptsHint: '仅在该账号命中映射后的真实上游模型时，将此提示词前置到客户端系统提示词。',
      modelSystemPromptModelPlaceholder: '真实上游模型，例如 gpt-5.4',
      modelSystemPromptTextPlaceholder: '输入要前置注入的系统提示词',
      addModelSystemPrompt: '添加模型提示词',
      modelSystemPromptRequired: '模型名称和系统提示词不能为空',
      modelSystemPromptDuplicate: '模型 {model} 配置重复',
      modelSystemPromptTooLong: '模型 {model} 的系统提示词不能超过 32 KiB',
      fromModel: '源模型',
      toModel: '目标模型',
