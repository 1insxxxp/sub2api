export default {
    accounts: {
      ...
      notesHint: '备注可选',
      modelSystemPrompts: '模型系统提示词',
      modelSystemPromptsHint: '可为此账号的特定模型设置系统提示词。',
      addModelSystemPrompt: '添加模型系统提示词',
      modelSystemPromptModelPlaceholder: '模型名称',
      modelSystemPromptTextPlaceholder: '系统提示词',
      modelSystemPromptRequired: '模型名称和系统提示词不能为空',
      modelSystemPromptTooLong: '{model} 的系统提示词过长',
      modelSystemPromptDuplicate: '该模型已存在系统提示词',
      modelAliasRenameCascadeSuccess: '已更新 {count} 个关联模型引用',
      modelAliasRenameCascadePartial: '已更新 {count} 个关联模型引用，跳过 {skipped} 个',
      modelAliasRenameCascadeFailed: '更新关联模型引用失败：{message}',
      // Filter options
      allPlatforms: '全部平台',
      allTypes: '全部类型',
      allStatus: '全部状态',
      ...
      actualModel: '实际模型',
      addMapping: '添加映射',
      generateMappingsFromWhitelist: '从白名单生成映射',
      modelMappingPrefix: '统一前缀',
      modelMappingPrefixPlaceholder: '例如：按次/',
      prependMappingPrefix: '统一添加前缀',
      modelMappingWhitelistEmpty: '请先在模型白名单中选择模型',
      modelMappingPrefixEmpty: '请输入统一前缀',
      modelMappingsGenerated: '已新增 {count} 条映射',
      modelMappingPrefixesApplied: '已更新 {count} 条请求模型名称',
      modelMappingBulkHint: '前缀添加到左侧请求模型名，右侧上游模型名保持不变',
      modelMappingRemovePrefix: '删除上游统一前缀（可选）',
      modelMappingRemoveSuffix: '删除上游统一后缀（可选）',
      modelMappingCleanup: '按清洗结果重建请求名',
      modelMappingCleanupHint: '右侧保留真实上游模型名，先删除其统一前缀/后缀，再给清洗后的名称加统一前缀生成左侧请求名。',
      modelMappingCleanupPrefixEmpty: '请先填写统一前缀',
      modelMappingCleanupEmpty: '请输入要删除的上游前缀或后缀',
      modelMappingCleanupApplied: '已重建 {count} 个请求模型名，发现 {collisions} 个冲突',
      modelMappingCleanupPreview: '预览：将重建 {count} 个请求模型名，发现 {collisions} 个冲突',
      ...
      stopBatchTest: '停止批量测试',
      batchTotalCount: '共 {count} 个',
      batchSuccessCount: '成功 {count} 个',
      batchFailedCount: '失败 {count} 个',
      batchCancelledCount: '已取消 {count} 个',
      batchPending: '等待中',
      batchTesting: '测试中',
      batchSuccess: '成功',
      batchFailed: '失败',
