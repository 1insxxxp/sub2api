export default {
    accounts: {
      ...
      modelMappingCleanup: '清洗上游模型名',
      modelMappingCleanupEmpty: '请输入要删除的上游前缀或后缀',
      modelMappingCleanupApplied: '已清洗 {count} 个上游模型名，发现 {collisions} 个冲突',
      modelMappingCleanupPreview: '预览：将修改 {count} 个模型名，发现 {collisions} 个冲突',
