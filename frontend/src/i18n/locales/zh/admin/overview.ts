export default {
    ...
    affiliates: {
      summaryDescription: '按邀请人查看邀请与返利汇总',
      ...
      summary: {
        ...
        sortHint: '点击列排序，快速查找邀请人数最多或最少的用户',
        inviter: '邀请人',
        invitedCount: '邀请人数',
        qualifiedCount: '有效邀请',
        totalRebate: '累计返利',
        availableQuota: '可提余额',
        transferredAmount: '已提取',
      ...
      records: {
        ...
        qualifiedInvite: '本次邀请有效',
        unqualifiedInvite: '本次邀请暂未生效',
        qualifiedInviteesSummary: '有效 {qualified} / 邀请 {invited}',
        effectiveRate: '实际返利比例',
      ...
      overview: {
        ...
        automaticTier: '自动等级',
        qualifiedInvitees: '有效邀请人数',
        qualifiedInviteesSummary: '有效 {qualified} / 邀请 {invited}',
        automaticRate: '自动返利比例',
        customOverride: '自定义覆盖',
        effectiveRate: '实际返利比例',
        none: '无',
        availableQuota: '可提余额',
    ...
    users: {
      ...
      form: {
        ...
        balanceRedeemCodeEnabled: '允许兑换余额兑换码',
        balanceRedeemCodeEnabledHint: '开启后，用户可以将自己的余额转换为一次性兑换码提供给其他用户。'
      },
      adjustBalance: '调整余额',
      ...
      typeEmptyResponse: '空响应补偿',
      emptyResponseUsageLog: '用量记录 #{id}',
    ...
    groups: {
      ...
      emptyResponseCompensation: {
        enable: '允许用户自助申请空响应退款',
        hint: '这是用户退款政策，不代表上游一定退款。符合条件的空响应或中断响应会自动退款，存在歧义的情况需要人工审核。'
      },
      systemCustom: {
        ...
        manageAction: '管理来源',
        typeBadge: '系统自定义',
        namePlaceholder: '例如：全站模型月卡',
        quotaTitle: '共享订阅额度',
        quotaHint: '所有路由共享此月卡额度。留空表示不限制用量。',
        sourcesTitle: '来源分组',
        sourcesHint: '选择该订阅使用的分组，模型会自动同步。',
        noSources: '暂无符合条件的直接来源分组',
        sourceUnavailable: '此来源不可用，请移除后再保存。',
        unavailableSourceFallback: '不可用来源 #{source}',
        priorityTitle: '来源优先级',
        priorityHint: '匹配到模型后按从上到下的顺序回退。',
        sourceModelCount: '{count} 个模型',
        moveUp: '上移',
        moveDown: '下移',
        dynamicModelsTitle: '动态模型目录',
        dynamicModelsHint: '来源分组中的模型新增、移除和重命名会自动同步到这里。',
        selectedSources: '来源',
        uniqueModels: '模型',
        fallbackRoutes: '回退路由',
        modelsTitle: '模型路由',
        modelsHint: '显式选择公开模型。重名模型需要设置唯一别名。',
        selectAll: '全选',
        deselectAll: '取消全选',
        selectAllAll: '选择全部分组',
        selectAllSource: '选择此分组',
        showAdvancedSettings: '更多设置',
        hideAdvancedSettings: '收起设置',
        crossProtocolHint: '选择了混合协议。Claude/OpenAI 兼容端点会将请求转换后发送到所选来源；原生 Gemini API 只能调用 Gemini 来源模型。',
        selectSourceFirst: '请先选择来源分组以设置优先级',
        sourceModel: '来源模型',
        publicModel: '公开模型名称',
        conflictTitle: '公开模型名称冲突',
        conflictHint: "请重命名为唯一名称，例如 model{'@'}source。",
        syncTitle: '同步来源变更',
        syncHint: '预览不会修改路由，请确认变更后保存完整快照。',
        syncAction: '检查变更',
        syncAdded: '新增',
        syncMissing: '缺失',
        syncConflicting: '冲突',
        addedUnselected: '默认未导入',
        disableSuggestion: '选择以停用此过期路由',
        alreadyDisabled: '已停用',
        snapshotHint: '保存会更新来源优先级，模型会自动跟随来源变化。',
        saved: '自定义订阅分组已保存',
        deleteAction: '删除自定义分组',
        deleteConfirm: '确定删除此分组吗？已被套餐或订阅使用的分组无法删除。',
        deleting: '删除中...',
        deleted: '自定义路由分组已删除',
        deleteFailed: '删除自定义订阅分组失败',
        syncSourceUnavailable: '无法添加 {model}：来源分组 {source} 不可用或模型已失效。',
        loadFailed: '加载自定义订阅分组失败',
        saveFailed: '保存自定义订阅分组失败',
        groupExists: '同名分组已存在，请重命名或编辑现有分组。',
        syncFailed: '加载同步预览失败'
      },
      ...
      modelPricing: {
        ...
        required: '需要定价',
        requiredTitle: '需要定价',
        requiredHint: '{models} 没有可用价格，完成配置后会再次检查。',
        requiredSummary: '{count} 个选中模型需要定价',
        checking: '正在检查模型价格…',
        ready: '所有选中模型均有可用价格',
        saveBlocked: '请先完成所需模型定价'
      },
      voicePricing: {
        title: 'Grok Voice 定价',
      ...
      defaultReasoning: {
        title: '默认思考强度',
        hint: '仅在客户端未发送 thinking 或 output_config.effort 时注入，不会覆盖客户端显式设置。',
        off: '关闭（不注入）',
        low: '低',
        medium: '中',
        high: '高',
