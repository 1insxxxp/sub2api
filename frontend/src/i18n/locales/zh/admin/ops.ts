export default {
    ops: {
      ...
      errorDetails: {
        ...
        summaryAction: '查看明细',
        slaSummaryButton: '分组定位',
        slaSummaryTitle: 'SLA 错误分组定位',
        slaSummaryLoading: '正在加载 SLA 错误摘要…',
        slaSummaryError: 'SLA 错误摘要加载失败。',
        slaSummaryRetry: '重试',
        slaSummaryEmpty: '当前筛选条件下暂无计入 SLA 的错误。',
        slaSummaryTotalErrors: '错误数',
        slaSummaryGroups: '分组数',
        slaSummaryLatest: '最新时间',
        slaSummaryTruncated: '结果已截断，仅显示部分分组。',
        slaSummaryNestedTruncated: '已截断（共 {count} 项）',
        slaSummaryPath: '定位路径',
        slaSummaryPathHint: '分组 → 模型 → 账号 → SLA 失败原因',
        slaSummaryErrorsShort: '条错误',
        slaSummaryModelsShort: '个模型',
        slaSummaryAccountsShort: '个账号',
        slaSummaryModel: '模型',
        slaSummaryAccount: '账号',
        slaSummaryReason: '失败原因',
        slaSummaryStatus: '状态码',
        slaSummaryCount: '次数',
        slaSummaryLatestTime: '最新时间',
        slaSummaryAction: '查看明细',
