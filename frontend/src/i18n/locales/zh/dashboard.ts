export default {
  ...
  keys: {
    ...
    allStatus: '全部状态',
    columnSettings: '列设置',
    columnSettingsHint: '选择需要在密钥列表中显示的信息',
  ...
  usage: {
    ...
    emptyResponse: {
      ...
      originalCharge: '原扣费',
      expectedRefund: '预计补偿',
      rules: '7 天内、已扣费且输出 Token ≤ 10 的请求可提交补偿；每天前 15 次按规则自动处理，超出或证据冲突会进入人工审核。系统只使用结构化信号，不读取或保存响应正文。',
      reason: '补充说明（可选）',
      reasonPlaceholder: '例如：客户端只收到空白或极短回复，重试后恢复正常',
      submitting: '提交中...',
      submit: '提交申请',
      refunded: '已补偿',
      netCharge: '净扣费',
      action: '申请补偿',
      actionHint: '适用于空白回复或输出 Token 不超过 10 的请求',
      submitSuccess: '补偿申请已提交',
      submitFailed: '提交补偿申请失败',
      status: {
        evaluating: '判定中',
        manual_review: '待人工审核',
        approved: '已批准',
      ...
      reasonCode: {
        ...
        low_output: '输出 Token 不超过 10',
        upstream_http_5xx: '上游服务错误',
        upstream_timeout: '上游超时',
        upstream_interrupted: '上游流式响应中断',
        client_cancelled: '客户端主动取消',
        effective_output: '检测到有效输出',
        not_charged: '该请求未扣费',
  ...
  availableChannels: {
    ...
    catalog: {
      ...
      channelsCount: '{count} 个渠道',
      modelsCount: '{count} 个模型',
      moreOfferings: '查看渠道方案（{count}）',
      showOfferings: '查看渠道方案（{count}）',
      hideOfferings: '收起渠道方案',
      offeringsColumn: '方案',
      ...
      rateFallback: '专属倍率暂不可用，当前显示默认倍率',
      loading: '正在加载可用渠道',
      refreshing: '正在更新渠道数据',
      empty: '暂无可用渠道',
      noChannels: '暂无可用渠道',
  ...
  affiliate: {
    ...
    campaign: {
      eyebrow: '推广控制台',
      title: '邀请好友，解锁更高返利',
      subtitle: '复制邀请素材、查看合格首充进度，并把可用返利额度转入站内余额。',
      nextTier: '还差 {count} 位合格邀请解锁 {level}',
      maxTier: '已解锁最高等级',
      stepsTitle: '三步拿奖励',
      stepRegisterTitle: '好友完成注册',
      stepRegisterDescription: '新用户通过你的邀请链接或邀请码注册后，自动计入邀请关系。',
      stepRechargeTitle: '好友实付满 {amount}',
      stepRechargeDescription: '被邀请用户累计实付达到门槛后，会成为合格邀请人数。',
      stepRewardTitle: '你获得返利',
      stepRewardDescription: '返利按当前等级比例发放，可用额度支持一键转入余额。',
      toolsTitle: '邀请工具',
      toolsDescription: '把社群推广常用的邀请码、链接和话术放在这里，复制更顺手。',
      copyPitch: '复制推广文案',
      pitchCopied: '推广文案已复制',
      pitchTemplate: '这个 AI 站注册即送体验额度，支持 GPT、Claude、Gemini 全模型，每天还可以签到领免费额度：{link}',
      progressTitle: '当前完成度',
      progressDescription: '合格邀请人数越多，推广等级和返利比例越高，达标后永久保留。',
      qualifiedRatio: '合格率',
      mobileCta: '复制邀请链接'
    },
    tiers: {
    ...
    rewards: {
      ...
      requirement: '{count} 位合格邀请',
      balanceBenefit: '奖励 {amount} 余额',
      subscriptionBenefit: '奖励 {group} 订阅 {days} 天',
      groupFallback: '分组 #{id}',
      subscriptionGeneric: '订阅',
      remaining: '还差 {count} 位合格邀请可领取',
      claim: '领取兑换码',
      claiming: '领取中...',
      claimSuccess: '已领取兑换码：{code}',
      claimFailed: '领取阶梯奖励失败',
      copyCode: '复制兑换码',
      codeCopied: '兑换码已复制'
    },
    transfer: {
  ...
  redeem: {
    ...
    balanceTransfer: {
      ...
      singleUsePerUser: '一人限用一次',
      singleUsePerUserHint: '本次生成的兑换码共享同一批次，每个账号最多兑换其中一个。',
      ...
      copyFailed: '复制失败',
      generated: '兑换码已生成',
      generatedModalTitle: '生成成功',
      generatedModalSubtitle: '已创建 {count} 个兑换码',
      deleted: '兑换码已删除，额度已退回',
      deleteConfirm: '删除该未使用兑换码后会把额度退回余额，确认删除？',
      batchDelete: '批量删除',
      ...
      invalidCount: '生成数量必须在 1 到 100 之间',
