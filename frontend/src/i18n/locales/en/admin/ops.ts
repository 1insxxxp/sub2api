export default {
    ops: {
      ...
      errorDetails: {
        ...
        total: 'Total:',
        summaryButton: 'Group view',
        summaryTitle: 'Upstream error groups',
        summaryLoading: 'Loading grouped summary…',
        summaryError: 'Failed to load grouped summary.',
        summaryRetry: 'Retry',
        summaryEmpty: 'No upstream errors match the current filters.',
        summaryTotalErrors: 'Errors',
        summaryGroups: 'Groups',
        summaryLatest: 'Latest',
        summaryTruncated: 'Results are truncated; only some groups are shown.',
        summaryNestedTruncated: 'Truncated ({count} total)',
        ...
        slaSummaryButton: 'Group view',
        slaSummaryTitle: 'SLA error groups',
        slaSummaryLoading: 'Loading SLA error summary…',
        slaSummaryError: 'Failed to load SLA error summary.',
        slaSummaryRetry: 'Retry',
        slaSummaryEmpty: 'No SLA errors match the current filters.',
        slaSummaryTotalErrors: 'Errors',
        slaSummaryGroups: 'Groups',
        slaSummaryLatest: 'Latest',
        slaSummaryTruncated: 'Results are truncated; only some groups are shown.',
        slaSummaryNestedTruncated: 'Truncated ({count} total)',
        slaSummaryPath: 'Trace path',
        slaSummaryPathHint: 'Group → model → account → SLA failure reason',
        slaSummaryErrorsShort: 'errors',
        slaSummaryModelsShort: 'models',
        slaSummaryAccountsShort: 'accounts',
        slaSummaryModel: 'Model',
        slaSummaryAccount: 'Account',
        slaSummaryReason: 'Failure reason',
        slaSummaryStatus: 'Status',
        slaSummaryCount: 'Count',
        slaSummaryLatestTime: 'Latest time',
        slaSummaryAction: 'Details',
