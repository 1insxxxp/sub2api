export default {
    accounts: {
      ...
      generateMappingsFromWhitelist: 'Generate Mappings from Whitelist',
      modelMappingPrefix: 'Shared Prefix',
      modelMappingPrefixPlaceholder: 'For example: per-request/',
      prependMappingPrefix: 'Add Prefix to All',
      modelMappingWhitelistEmpty: 'Select models in the model whitelist first',
      modelMappingPrefixEmpty: 'Enter a shared prefix',
      modelMappingsGenerated: 'Added {count} mapping(s)',
      ...
      modelMappingCleanup: 'Rebuild Request Names',
      modelMappingCleanupHint:
        'The right side stays as the real upstream model. Remove its shared prefix/suffix, then add the unified prefix to rebuild the left request name.',
      modelMappingCleanupPrefixEmpty: 'Enter a unified prefix first',
      modelMappingCleanupEmpty: 'Enter an upstream prefix or suffix to remove',
      modelMappingCleanupApplied: 'Rebuilt {count} request name(s); {collisions} collision(s) detected',
      modelMappingCleanupPreview: 'Preview: {count} request name(s) will change, {collisions} collision(s)',
      ...
      stopBatchTest: 'Stop Batch Test',
      batchTotalCount: '{count} total',
