export default {
    ...
    affiliates: {
      ...
      records: {
        ...
        qualifiedInvitees: 'Valid Invites',
        qualifiedInvite: 'This invite is valid',
        unqualifiedInvite: 'This invite is not valid yet',
        qualifiedInviteesSummary: 'Valid {qualified} / Invited {invited}',
    ...
    groups: {
      ...
      systemCustom: {
        createAction: 'New custom subscription group',
        createTitle: 'New custom subscription group',
        editTitle: 'Manage custom subscription group',
        manageAction: 'Manage sources',
        typeBadge: 'System custom',
        namePlaceholder: 'Example: Tavern all-access monthly pass',
        quotaTitle: 'Shared subscription quota',
        quotaHint: 'Every route shares this monthly-pass quota. Leave a limit empty for unlimited usage.',
        sourcesTitle: 'Source groups',
        sourcesHint: 'Choose groups for this subscription. Their models stay in sync automatically.',
        noSources: 'No eligible direct source groups',
        sourceUnavailable: 'This source is unavailable. Remove it before saving.',
        unavailableSourceFallback: 'Unavailable source #{source}',
        priorityTitle: 'Source priority',
        priorityHint: 'A matching model falls through from top to bottom.',
        sourceModelCount: '{count} models',
        moveUp: 'Move up',
        moveDown: 'Move down',
        dynamicModelsTitle: 'Dynamic model catalog',
        dynamicModelsHint: 'Model additions, removals, and renames in source groups are reflected here automatically.',
        ...
        hideAdvancedSettings: 'Hide settings',
        crossProtocolHint: 'Mixed protocols selected. Claude/OpenAI-compatible endpoints convert requests for the chosen source; the native Gemini API can only call Gemini source models.',
        selectSourceFirst: 'Select a source group to set its priority',
        sourceModel: 'Source model',
        publicModel: 'Public model name',
        conflictTitle: 'Public model name conflict',
        conflictHint: "Rename it to a unique name such as model{'@'}source before saving.",
        syncTitle: 'Sync source changes',
        syncHint: 'Previewing never changes routes. Confirm changes and save one complete snapshot.',
        syncAction: 'Check changes',
        syncAdded: 'Added',
        syncMissing: 'Missing',
        ...
        snapshotHint: 'Saving updates source priority; models follow source changes automatically.',
        saved: 'Custom subscription group saved',
        deleteAction: 'Delete custom group',
        deleteConfirm: 'Delete this group? Groups used by a plan or subscription cannot be deleted.',
        deleting: 'Deleting...',
        deleted: 'Custom routing group deleted',
        deleteFailed: 'Failed to delete custom subscription group',
        syncSourceUnavailable: 'Cannot add {model}: source group {source} is unavailable or the model is no longer valid.',
        loadFailed: 'Failed to load custom subscription group',
        saveFailed: 'Failed to save custom subscription group',
      ...
      modelPricing: {
        ...
        requiredTitle: 'Pricing required',
        requiredHint: 'No usable price exists for {models}. The check runs again after you complete this entry.',
        requiredSummary: '{count} selected models need pricing',
        checking: 'Checking model prices…',
        ready: 'Every selected model has usable pricing',
        saveBlocked: 'Complete the required model pricing first'
      },
      voicePricing: {
