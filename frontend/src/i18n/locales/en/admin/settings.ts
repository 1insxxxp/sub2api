    ...
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          ...
          priceCnyMultiplier: 'Minimum recharge ratio',
          priceCnyMultiplierHint: 'Sets the lower bound of the site-price range in Available Channels. It only affects display and never actual billing. Use 0 to hide the site-price range.',
          priceCnyMultiplierMax: 'Maximum recharge ratio',
          priceCnyMultiplierMaxHint: 'Sets the upper bound of the site-price range in Available Channels and defaults to 0.20. It only affects display, never actual billing. Values below the minimum are saved as the minimum.',
          priceCnyPreview: 'Example: official $10 / 1M tokens with 1x group rate displays ¥{value} / 1M tokens.',
          officialUsdToCnyRate: 'Official USD to CNY rate',
          officialUsdToCnyRateHint: 'Only used for the savings badge: converts the official USD price to CNY before comparing it with the site price. Defaults to 7; use 0 to hide savings.',
        },
        siteBillingMode: {
        ...
        affiliate: {
          ...
          qualificationAmount: 'Qualifying Payment Amount',
          qualificationAmountHint: 'An invitee becomes qualified after reaching this cumulative paid amount.',
          tiers: {
            title: 'Promotion Tiers',
            threshold: 'Qualified invitees',
            rate: 'Rebate rate',
            standardHint: 'Base tier',
            hint: 'Tier thresholds count qualified invitees. Per-user custom rates still override the automatic tier rate.',
      ...
      customMenu: {
        ...
        description: 'Add custom pages to the sidebar and choose embedded or new-tab navigation. Each page can be visible to regular users or administrators.',
        ...
        openMode: 'Open Mode',
        openModeEmbedded: 'Embedded in Site',
        openModeNewTab: 'New Tab',
        openModeHint: 'New-tab mode opens the original URL without appending a user ID, sign-in token, or embed parameters.',
        openModeMarkdownHint: 'Markdown pages can only open inside the site.',
        add: 'Add Menu Item',
        remove: 'Remove',
        moveUp: 'Move Up',
        moveDown: 'Move Down',
      ...
      payment: {
        ...
        rechargePromotion: {
          ...
          hint: 'One scheduled campaign replaces the regular recharge multiplier. Blacklisted users pay the regular price.',
          name: 'Campaign name',
          namePlaceholder: 'e.g. Anniversary bonus',
          startAt: 'Starts at',
          endAt: 'Ends at',
          multiplier: 'Promotion multiplier',
          multiplierHint: 'Must be positive while the campaign is enabled.',
          blacklist: 'Price blacklist',
          blacklistHint: 'Search by email or user ID. Blacklisted users keep the regular multiplier.',
          searchUsers: 'Search users by email or ID',
          noUsers: 'No users found',
          userFallback: 'User #{id}',
          removeUser: 'Remove user',
          invalidMultiplier: 'Enter a positive promotion multiplier.',
          invalidRange: 'End time must be after start time.',
        },
        balanceRechargeMultiplier: 'Balance Recharge Multiplier',
        rechargeTiers: 'Quick Recharge Amounts',
        addRechargeTier: 'Add quick amount',
        rechargeTiersHint: 'Users can only choose configured recharge amounts. Each amount has its own multiplier; empty rules use the global multiplier.',
        tierAmount: 'Quick amount',
        tierMultiplierPlaceholder: 'Enter multiplier',
        invalidRechargeTiers: 'Enter unique positive amounts and a positive multiplier for each amount.',
      ...
      modelFirstOutputTimeout: {
        ...
        profiles: 'Profiles',
        overrides: 'Overrides',
        defaultTitle: 'Global Default Policy',
        globalPolicy: 'Global policy',
        profileTitle: 'Gemini Profiles',
        profileHint: 'Configure independent policies for Flash, Pro, and Thinking.',
        platformTitle: 'Platform Overrides',
        platformHint: 'Add a platform override, such as gemini or openai.',
        modelTitle: 'Model Overrides',
        modelHint: 'Add a model-specific policy. Model overrides take precedence over platform and default policies.',
        ...
        switchSeconds: 'Switch (seconds)',
        hardCapSeconds: 'Hard cap (seconds)',
        retryHint: 'First output only; retries at most once after a timeout. Values must be positive, no more than 900 seconds, and follow target ≤ switch ≤ hard cap.',
        validationPositive: 'All timeout values must be positive numbers from 1 to 900 seconds.',
        validationOrder: 'Timeout values must follow target ≤ switch ≤ hard cap.',
        loadFailed: 'Failed to load first output timeout settings',
        saved: 'First output timeout settings saved',
        saveFailed: 'Failed to save first output timeout settings',
        profile: {
