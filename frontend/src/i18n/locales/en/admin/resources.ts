export default {
    ...
    usage: {
      ...
      rechargeRanking: { exportCurrentPage: 'Export current page CSV', subtitle: 'User recharge ranking from balance ledger', countDescription: '(Count includes online recharge, redeem codes, and admin adjustments only)', unbound: 'Unbound', loadFailed: 'Failed to load recharge ranking', allSources: 'All sources', sortAsc: 'Ascending', sortDesc: 'Descending', summaryUsers: 'Recharge users', summaryCount: 'Recharge count', summaryTotal: 'Added balance', summaryOnline: 'Online recharge', sources: { online: 'Online', redeem: 'Redeem code', affiliate: 'Affiliate', admin: 'Admin adjustment', reward: 'Rewards', refund: 'Refund', other: 'Other' }, columns: { rank: 'Rank', user: 'User', inviter: 'Current inviter', inviterId: 'Inviter ID', inviterEmail: 'Inviter email', inviterUsername: 'Inviter username', total: 'Added balance', online: 'Online', redeem: 'Redeem', affiliate: 'Affiliate', admin: 'Admin', reward: 'Rewards', refund: 'Refund', other: 'Other', count: 'Count', last: 'Last recharge' } },
      cleanup: {
        button: 'Cleanup',
