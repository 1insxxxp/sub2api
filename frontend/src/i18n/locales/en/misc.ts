export default {
  ...
  payment: {
    ...
    rechargeOfferTitle: 'Recharge Offers',
    rechargeOfferHint: 'Choose a quick amount to see the credited balance and bonus calculated by the current rules.',
    rechargeOfferAmount: 'Recharge Amount',
    rechargeOfferCredit: 'Credited Balance',
    rechargeOfferBonus: 'bonus',
    rechargeOfferIncludedHint: 'The credited total already includes the bonus; it is not added again.',
    rechargeOfferCreditTotal: 'Credited Total',
    rechargeOfferBase: 'Base',
    rechargeOfferBonusIncluded: 'Includes bonus',
    rechargePromotionBadge: 'Limited activity',
