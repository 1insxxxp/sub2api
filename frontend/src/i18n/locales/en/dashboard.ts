export default {
  ...
  usage: {
    ...
    emptyResponse: {
      title: 'Request empty or low-output compensation',
      eyebrow: 'Self-service refund',
      ...
      rules: 'Charged requests from the last 7 days with 10 output tokens or fewer can be claimed. The first 15 claims per day are handled by rule; overflow or conflicting evidence goes to manual review. Response content is never read or stored.',
      reason: 'Additional context (optional)',
      reasonPlaceholder: 'For example: the client received a blank or very short reply and retrying worked',
      submitting: 'Submitting...',
      submit: 'Submit claim',
      refunded: 'Refunded',
      netCharge: 'Net charge',
      action: 'Claim refund',
      actionHint: 'Applies to blank replies or responses with 10 output tokens or fewer',
      submitSuccess: 'Compensation claim submitted',
      submitFailed: 'Failed to submit compensation claim',
      status: {
      ...
      reasonCode: {
        ...
        low_output: '10 output tokens or fewer',
        upstream_http_5xx: 'Upstream service error',
        upstream_timeout: 'Upstream timeout',
        upstream_interrupted: 'Upstream stream interrupted',
        client_cancelled: 'Client canceled the request',
        effective_output: 'Effective output was detected',
  ...
  availableChannels: {
    ...
    catalog: {
      ...
      moreOfferings: 'View channel offerings ({count})',
      showOfferings: 'View channel offerings ({count})',
      hideOfferings: 'Hide channel offerings',
      ...
      rateFallback: 'Personal rates are temporarily unavailable. Default rates are shown.',
  ...
  affiliate: {
    ...
    campaign: {
      ...
      title: 'Invite friends, unlock higher rebates',
      subtitle: 'Copy invite materials, track qualified recharge progress, and transfer available rebate quota into balance.',
      nextTier: '{count} more qualified invitees to unlock {level}',
      maxTier: 'Top tier unlocked',
      stepsTitle: '3-step reward path',
      stepRegisterTitle: 'Friend registers',
      stepRegisterDescription: 'New users are linked to you when they sign up from your invite link or affiliate code.',
      stepRechargeTitle: 'Friend pays {amount}',
      stepRechargeDescription: 'Cumulative paid purchases turn the invitee into a qualified invite.',
      stepRewardTitle: 'You earn rebates',
      stepRewardDescription: 'Rebates follow your current tier rate and available quota can be moved into balance.',
      toolsTitle: 'Invite toolkit',
      toolsDescription: 'Keep the code, link, and pitch users need for group sharing in one place.',
      copyPitch: 'Copy pitch',
      pitchCopied: 'Pitch copied',
      pitchTemplate: 'Sign up for trial credits, access GPT, Claude, Gemini, and other models, and check in daily for free credits: {link}',
      progressTitle: 'Progress center',
      progressDescription: 'More qualified invitees unlock higher permanent promotion tiers and rebate rates.',
      qualifiedRatio: 'Qualified ratio',
      mobileCta: 'Copy invite link'
    },
    tiers: {
    ...
    rewards: {
      ...
      requirement: '{count} qualified invitees',
      balanceBenefit: '{amount} balance reward',
      subscriptionBenefit: '{group} subscription reward for {days} days',
      groupFallback: 'Group #{id}',
      subscriptionGeneric: 'subscription',
      remaining: '{count} more qualified invitees to claim',
      claim: 'Claim redeem code',
      claiming: 'Claiming...',
      claimSuccess: 'Redeem code claimed: {code}',
      claimFailed: 'Failed to claim milestone reward',
      copyCode: 'Copy code',
      codeCopied: 'Redeem code copied'
    },
    transfer: {
  ...
  redeem: {
    ...
    balanceTransfer: {
      ...
      singleUsePerUser: 'One per recipient',
      singleUsePerUserHint: 'Codes from this generation share one batch; each account can redeem at most one.',
      ...
      generatedModalTitle: 'Generated Successfully',
      generatedModalSubtitle: 'Created {count} redeem codes',
      deleted: 'Redeem code deleted and balance refunded',
      deleteConfirm: 'Delete this unused redeem code and refund the balance?',
      ...
      singleUseBadge: 'One per account',
      ...
      invalidCount: 'Count must be between 1 and 100',
