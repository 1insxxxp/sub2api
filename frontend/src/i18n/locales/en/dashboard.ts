export default {
  ...
  usage: {
    ...
    emptyResponse: {
      title: 'Request empty-response compensation',
      ...
      rules: 'Eligibility uses privacy-safe structural signals only; response content is never read or stored. Clear empty responses are refunded automatically, while missing or conflicting evidence is reviewed manually.',
