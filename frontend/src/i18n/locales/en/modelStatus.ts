export default {
  modelStatus: {
    ...
    customGroupPrefix: 'My custom group',
    customGroupLoading: 'Loading custom groups...',
    ...
    noCustomGroupMatches: 'No available monitored models in this custom group',
    customGroupsLoadFailed: 'Custom groups could not be loaded. Showing public groups only.',
