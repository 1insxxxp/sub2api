export default {
  common: {
    ...
    noData: 'No data',
    expand: 'Expand',
    sidebarSettings: 'Sidebar items',
    sidebarSettingsReset: 'Reset default',
    sidebarSettingsRequired: 'Required',
    details: 'Details',
    collapse: 'Collapse',
    success: 'Success',
    error: 'Error',
  ...
  adminWorkbench: {
    ...
    balanceTransfer: {
      ...
      subtitle: 'Convert this account balance into one-time redeem codes.',
      amount: 'Single value',
      ...
      singleUsePerUser: 'One use per user',
      singleUsePerUserHint: 'Useful for campaigns where one user should not redeem twice.',
      ...
      generatedNowHint: 'Copy the newly generated codes directly.',
      noGeneratedNow: 'No newly generated codes',
      generatedList: 'My generated codes',
      generatedListHint: 'Only balance redeem codes generated by this account are shown.',
      empty: 'No generated codes',
      status: {
        unused: 'Unused',
        used: 'Used',
        expired: 'Expired',
      ...
      singleUseBadge: 'one use per user',
      expiresAt: 'Expires',
      usedAt: 'Used',
      invalidAmount: 'Enter a valid amount',
      invalidCount: 'Quantity must be between 1 and 100',
      invalidExpiry: 'Validity must be between 1 and 3650 days',
      insufficientBalance: 'Insufficient balance',
      failedToLoad: 'Failed to load redeem codes',
      failedToGenerate: 'Failed to generate redeem codes',
      deleteConfirm: 'Delete this redeem-code record? Unused value is refunded; used codes only remove the record.',
