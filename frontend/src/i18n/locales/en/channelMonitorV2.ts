...
export default {
  channelMonitorV2: {
    ...
    matrix: {
      title: 'Availability trend', description: 'Each row is a channel dimension and each block is an aggregate interval; hover for details', wheelZoom: 'Scroll over blocks to zoom in (narrower range, wider blocks)', wheelZoomX: 'Scroll over blocks to zoom in (narrower range, wider blocks)', dimension: 'Channel dimension', emptyTitle: 'No matrix data for the selected window', legendAria: 'Health score legend', bad: 'Bad', good: 'Good', healthyLegend: 'Healthy (≥80)', warningLegend: 'Watch (50–79)', criticalLegend: 'Critical (<50)', insufficientLegend: 'Insufficient samples', noTrafficLegend: 'No traffic', noTraffic: 'No traffic in this interval', noTrafficAt: '{time} · no traffic', lowSample: 'Low sample: alerting from the observed error rate', scoreLine: 'Health score {score}', resetZoom: 'Reset zoom'
    },
    chart: {
