...
const requiredEmptyResponseKeys = [
  ...
  'usage.emptyResponse.claimOne',
  'usage.emptyResponse.claimingOne',
  'usage.emptyResponse.submitSuccess',
  'usage.emptyResponse.singleClaimSuccess',
  'usage.emptyResponse.submitFailed',
  'usage.emptyResponse.dailyLimitReached',
  'usage.emptyResponse.statusLabel',
  'usage.emptyResponse.tokens',
  'usage.emptyResponse.tokenDetail',
  'usage.emptyResponse.claimRules.dailyLimit',
  'usage.emptyResponse.claimRules.tokenLimit',
  'usage.emptyResponse.bulk.title',
  'usage.emptyResponse.bulk.subtitle',
  'usage.emptyResponse.bulk.action',
  'usage.emptyResponse.bulk.claiming',
  'usage.emptyResponse.bulk.empty',
  'usage.emptyResponse.bulk.loadFailed',
  'usage.emptyResponse.bulk.claimSuccess',
  'usage.emptyResponse.bulk.claimFailed',
  'usage.emptyResponse.bulk.dailyRemaining',
  'usage.emptyResponse.status.claimable',
  ...
  'usage.emptyResponse.status.daily_limited',
