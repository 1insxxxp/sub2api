...
export function useChannelMonitorFormat() {
  ...
  function providerPickerClass(p: Provider | string, active: boolean): string {
    switch (p) {
      case PROVIDER_OPENAI:
        return active
          ? 'admin-choice-card-active border-emerald-500 text-emerald-700 dark:border-emerald-400 dark:text-emerald-300'
          : 'hover:border-emerald-300 hover:text-emerald-700 dark:hover:border-emerald-500/50'
      case PROVIDER_ANTHROPIC:
        return active
          ? 'admin-choice-card-active border-orange-500 text-orange-700 dark:border-orange-400 dark:text-orange-300'
          : 'hover:border-orange-300 hover:text-orange-700 dark:hover:border-orange-500/50'
      case PROVIDER_GEMINI:
        return active
      ...
      case PROVIDER_ANTIGRAVITY:
        return active
          ? 'admin-choice-card-active border-purple-500 text-purple-700 dark:border-purple-400 dark:text-purple-300'
          : 'hover:border-purple-300 hover:text-purple-700 dark:hover:border-purple-500/50'
      case PROVIDER_KIMI:
        return active
          ? 'admin-choice-card-active border-pink-500 text-pink-700 dark:border-pink-400 dark:text-pink-300'
          : 'hover:border-pink-300 hover:text-pink-700 dark:hover:border-pink-500/50'
      case PROVIDER_ZHIPU:
        return active
          ? 'admin-choice-card-active border-indigo-500 text-indigo-700 dark:border-indigo-400 dark:text-indigo-300'
          : 'hover:border-indigo-300 hover:text-indigo-700 dark:hover:border-indigo-500/50'
      case PROVIDER_DEEPSEEK:
        return active
      ...
      case PROVIDER_OPENCODE_GO:
        return active
          ? 'admin-choice-card-active border-amber-500 text-amber-800 dark:border-amber-400 dark:text-amber-300'
          : 'hover:border-amber-300 hover:text-amber-700 dark:hover:border-amber-500/50'
      default:
        return active
