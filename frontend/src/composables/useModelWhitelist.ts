...
const geminiPresetMappings = [
  ...
  { label: '3.1 Pro', from: 'gemini-3.1-pro-preview', to: 'gemini-3.1-pro-preview', color: 'bg-fuchsia-100 text-fuchsia-700 hover:bg-fuchsia-200 dark:bg-fuchsia-900/30 dark:text-fuchsia-400' },
