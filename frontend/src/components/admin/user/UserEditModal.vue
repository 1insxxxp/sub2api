...
const form = reactive({ email: '', password: '', username: '', notes: '', role: 'user', concurrency: 1, rpm_limit: 0, balance_redeem_code_enabled: false, customAttributes: {} as UserAttributeValuesMap })
