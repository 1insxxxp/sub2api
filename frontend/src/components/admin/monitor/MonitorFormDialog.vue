<template>
  ...
  >
    <form id="channel-monitor-form" @submit.prevent="handleSubmit" class="space-y-5">
      ...
      <div v-if="usesQuotaMode" class="admin-form-section">
      ...
      <div v-if="form.provider === PROVIDER_OPENAI && usesProbePart" class="admin-form-section rounded-lg border border-blue-100 bg-blue-50/50 p-3 dark:border-blue-500/20 dark:bg-blue-500/10">
      ...
      <div v-if="usesProbePart" class="admin-form-section">
      ...
      <details v-if="usesProbePart" class="admin-form-section rounded-lg border border-gray-200 bg-gray-50/50 p-3 dark:border-dark-700 dark:bg-dark-900/30">
...
function buildPayload(): CreateParams {
  return {
    ...
    model_mappings: usesProbePart.value ? normalizedModelMappings() : {},
