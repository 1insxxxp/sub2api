<template>
  <div class="admin-choice-card flex items-start gap-2 p-2"
       :class="isEmpty ? 'border-red-400 bg-red-50 text-red-700 dark:border-red-500 dark:bg-red-950/20 dark:text-red-200' : ''">
