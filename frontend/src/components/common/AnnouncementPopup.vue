  ...
  <Teleport to="body">
    <Transition name="popup-fade">
      <div
        ...
        class="brand-overlay z-[120] flex items-start justify-center overflow-y-auto p-4 pt-[8vh]"
      >
        <div
          class="brand-floating-panel w-full max-w-[680px] overflow-hidden"
          @click.stop
        >
          <div class="brand-floating-header px-8 py-6">
            <div class="relative z-10">
              ...
              <div class="mb-3 flex items-center gap-3">
                ...
                <span class="brand-floating-chip">
          ...
          <div class="max-h-[50vh] overflow-y-auto px-8 py-8">
            <div class="relative">
              <div class="absolute bottom-0 left-0 top-0 w-1 rounded-full bg-gradient-brand"></div>
              <div class="pl-6">
                <div
          ...
          <div class="border-t border-slate-200/80 bg-white/68 px-8 py-5 dark:border-white/10 dark:bg-white/[0.04]">
            <div class="flex items-center justify-end">
              <button
                @click="handleDismiss"
                class="btn btn-primary rounded-2xl px-6 py-2.5 text-sm"
              >
