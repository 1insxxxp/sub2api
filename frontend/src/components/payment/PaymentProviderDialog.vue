            ...
            <button
              ...
              :class="[
                ...
                form.payment_mode === mode.value
                  ...
                  : 'border-gray-300 bg-white text-gray-600 hover:border-primary-300 hover:bg-primary-50/60 hover:text-primary-700 dark:border-dark-600 dark:bg-dark-800 dark:text-gray-300 dark:hover:border-primary-500/40 dark:hover:bg-primary-500/10 dark:hover:text-primary-200',
              ]"
            >{{ mode.label }}</button>
          </div>
        </div>
