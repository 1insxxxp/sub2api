      ...
      <div v-else-if="usageInfo" class="space-y-1">
        ...
        <div v-if="grokLocalUsage" class="mb-0.5 flex items-center">
          <div class="flex items-center gap-1.5 text-[9px] text-gray-500 dark:text-gray-400">
            <span class="rounded-md bg-slate-100 px-1.5 py-0.5 dark:bg-slate-800">
              {{ formatWindowRequests(grokLocalUsage) }} req
            </span>
            <span class="rounded-md bg-slate-100 px-1.5 py-0.5 dark:bg-slate-800">
              {{ formatWindowTokens(grokLocalUsage) }}
            </span>
            <span class="rounded-md bg-slate-100 px-1.5 py-0.5 dark:bg-slate-800" :title="t('usage.accountBilled')">
