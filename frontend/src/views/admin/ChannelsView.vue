...
.channel-tab-inactive {
  @apply border-transparent text-gray-500 hover:border-primary-300 hover:text-primary-700 dark:text-gray-400 dark:hover:border-primary-500/40 dark:hover:text-primary-200;
}
</style>
