  ...
  <div class="admin-surface flex h-full flex-col p-6">
    <div class="mb-4 flex shrink-0 items-center justify-between">
      ...
      <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
        ...
        <template v-if="!props.fullscreen">
          <button
            type="button"
            class="admin-inline-action ml-2 !min-h-8 !min-w-0 !flex-row !rounded-lg !px-2 !py-1 !text-[11px] !font-semibold disabled:opacity-50"
          ...
          <button
            type="button"
            class="admin-inline-action !min-h-8 !min-w-0 !flex-row !rounded-lg !px-2 !py-1 !text-[11px] !font-semibold disabled:opacity-50"
            :disabled="state !== 'ready'"
    ...
    <div v-if="(props.topGroups?.length ?? 0) > 0" class="mb-3 flex flex-wrap gap-2">
      <button
        ...
        :key="g.group_id"
        type="button"
        class="admin-choice-card inline-flex items-center gap-2 rounded-full !px-3 !py-1 text-[11px] font-semibold"
