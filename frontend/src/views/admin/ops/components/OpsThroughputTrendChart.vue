...
<template>
  <div class="admin-surface flex h-full min-w-0 flex-col p-6">
    <div
    ...
    >
      ...
      >
        ...
        <template v-if="!props.fullscreen">
          <button
            type="button"
            class="admin-inline-action shrink-0 !min-h-8 !min-w-0 !flex-row !rounded-lg !px-2 !py-1 !text-[11px] !font-semibold disabled:opacity-50"
