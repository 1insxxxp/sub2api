...
<template>
      ...
      <div class="admin-form-section !space-y-3 !p-4">
        ...
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          <details class="col-span-1 md:col-span-2">
            ...
            <div class="admin-form-section mt-2 grid grid-cols-1 gap-3 !space-y-0 !rounded-xl !p-3 md:grid-cols-2">
  ...
  <BaseDialog :show="showAlertEditor" :title="t('admin.ops.runtime.alertTitle')" width="extra-wide" @close="showAlertEditor = false">
    <div v-if="draftAlert" class="space-y-4">
      ...
      <div class="admin-form-section !space-y-4 !p-4">
        ...
        <div v-if="draftAlert.silencing.enabled" class="mt-4 space-y-4">
          ...
          <div class="admin-list-surface p-4">
            ...
            <div v-if="!draftAlert.silencing.entries?.length" class="admin-empty-state mt-3 py-6 text-xs text-gray-500 dark:text-gray-400">
      ...
      <details class="admin-form-section !space-y-0 !p-3">
