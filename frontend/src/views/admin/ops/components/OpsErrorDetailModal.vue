  ...
  <BaseDialog :show="show" :title="title" width="full" :close-on-click-outside="true" @close="close">
    ...
    <div v-else class="space-y-6 p-6">
      ...
      <div class="admin-form-section !space-y-4 !p-6">
        ...
        <pre class="mt-4 max-h-[520px] overflow-auto rounded-xl border border-primary-100/70 bg-white/75 p-4 text-xs text-gray-800 dark:border-primary-400/10 dark:bg-white/[0.04] dark:text-gray-100"><code>{{ prettyJSON(primaryResponseBody || '') }}</code></pre>
      </div>
