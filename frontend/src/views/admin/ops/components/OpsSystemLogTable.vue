...
<template>
  <section class="admin-surface p-4">
    ...
    <div class="admin-form-section mb-4 !space-y-3 !rounded-xl !p-3">
    ...
    <div class="admin-toolbar-surface mb-4 grid grid-cols-1 gap-3 md:grid-cols-5">
      <label class="text-xs text-gray-600 dark:text-gray-300">
        时间范围
      ...
      <div v-else class="overflow-auto">
        <table class="min-w-full table-fixed divide-y divide-gray-200 dark:divide-dark-700">
          ...
          <tbody class="divide-y divide-gray-100 dark:divide-dark-800">
            <tr v-for="row in logs" :key="row.id" class="admin-list-row align-top">
