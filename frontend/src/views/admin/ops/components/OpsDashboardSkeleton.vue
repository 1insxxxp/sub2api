...
<template>
  <div class="space-y-6">
    ...
    <div :class="['admin-surface', props.fullscreen ? 'p-8' : 'p-6']">
      ...
      <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-12">
        <div class="admin-form-section !space-y-0 !p-4 lg:col-span-5">
        ...
        <div class="lg:col-span-7">
          <div class="grid h-full grid-cols-1 content-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div v-for="i in 6" :key="i" class="admin-form-section h-20 animate-pulse !space-y-0 !p-0"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4">
      <div :class="['admin-surface min-h-[360px] lg:col-span-1', props.fullscreen ? 'p-8' : 'p-6']">
      ...
      <div :class="['admin-surface min-h-[360px] lg:col-span-2', props.fullscreen ? 'p-8' : 'p-6']">
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
      <div
        v-for="i in 3"
        :key="i"
        :class="['admin-surface', props.fullscreen ? 'p-8' : 'p-6']"
      >
        <div class="h-4 w-44 animate-pulse rounded bg-gray-200 dark:bg-dark-700"></div>
    ...
    <div :class="['admin-surface', props.fullscreen ? 'p-8' : 'p-6']">
      ...
      <div class="mt-6 space-y-3">
        <div v-for="i in 6" :key="i" class="admin-list-row flex items-center justify-between gap-4 rounded-2xl border border-primary-100/60 bg-white/70 p-4 dark:border-primary-400/10 dark:bg-white/[0.03]">
