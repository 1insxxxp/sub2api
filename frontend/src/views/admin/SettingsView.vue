  ...
  <AppLayout>
    <div class="settings-admin-page w-full min-w-0 space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
              ...
              >
                ...
                <div v-else-if="captchaProviderSelection === 'tencent'">
                  <div class="mb-6 max-w-sm">
                    ...
                    <div class="admin-choice-card grid grid-cols-2 gap-2 p-1.5">
                      <button
                        type="button"
                      ...
                      >
                        ...
                        <template #option="{ option, selected }">
                          <GroupOptionItem
                            ...
                            :tag-color="(option as unknown as DefaultSubscriptionGroupOption).tag_color"
                            :name="
                              (
                                option as unknown as DefaultSubscriptionGroupOption
                              ).label
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
                  ...
                  >
                    <div class="flex items-start justify-between gap-3">
                      ...
                      <span
                        class="admin-choice-card !px-2 !py-0.5 text-[11px] font-medium text-gray-600 dark:text-gray-300"
                      >
                        %
                      </span>
                    </div>
          ...
          <div class="space-y-5 p-6">
            ...
            <div v-if="form.channel_monitor_enabled" class="space-y-5">
              <div>
                ...
                <div class="admin-choice-card mt-1.5 inline-flex w-full max-w-md p-1">
                  <button
                    type="button"
        ...
        <!-- Tab: Image Studio -->
        <div v-show='activeTab === "imageStudio"'>
        ...
        <!-- Save Button -->
        <div v-show="activeTab !== 'backup' && activeTab !== 'imageStudio'" class="flex justify-end">
          <button
            type="submit"
